       ...
       <div class="login_box">
              <div class="login_top">
                      ...
                      <div class="login_list">
                            ...
                            <div class="login_pa vertical showpwd"><img src="__IMG__/ig.png"></div>
                      </div>
              </div>
              <div class="login_mid">
                      <div class="login_b f16"><a id='login'>立即登录</a></div>
              ...
              <div class="login_btm">
                     ...
                     <div class="login_e"> 
                          <div class="login_e1"><a href=""><img src="__IMG__/tb_1.jpg"></a></div> 
                          <div class="login_e1"><a href=""><img src="__IMG__/tb_2.jpg"></a></div>
                          <div class="login_e1"><a href=""><img src="__IMG__/tb_3.jpg"></a></div> 
                     </div> 
              </div>        
      </div>                
</div>
  ...
  $(function(){
    ...
    login.click(function(){
      ...
      if (name == '') {
        ...
        $.post("{:U('Web/Member/ajaxlogin')}",data,function(res){
          if(res.code==200){
            alert(res.msg);
