                ...
                <div class="table_full">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>前身份证照</th>
                                <td><img src="{$data.idcard_front}" ondblclick='image_priview(this.src);' width="200px" height="200px"></td>
                            </tr>
                            <tr>
                                <th>后身份证照</th>
                                <td><img src="{$data.idcard_back}" ondblclick='image_priview(this.src);' width="200px" height="200px"></td>
                            </tr>
                    ...
                    <form class="J_ajaxForm" method="post" action="{:U('Admin/Apply/realnamereview')}">
                         <div class="bk10"></div>
