    ...
    <div style="background:#f4f4f4;">
        <div class="wrap">
            ...
            <div class="payment hidden">
                <div class="fl payment_main_01">
                    <span>填写报名表</span>
                </div>
                <div class="fl payment_main_05">
                    <!--灰色样式类名 payment_main_02    蓝色样式类名payment_main_05-->
                    <span>活动审核</span>
                </div>
                <div class="fl payment_main_03">
                    <!--灰色样式类名 payment_main_03    蓝色样式类名payment_main_06-->
                    <span>支付钱款</span>
                </div>
                <div class="fl payment_main_04">
        ...
        <div class="wrap">
            <div class="payment_main2 clearfix">
                <span class="payment_main2_span">活动审核信息 :</span>
                <div class="Landlord_confirmation_main">
                    <div class="Landlord_confirmation_main_1">
                        <div class="Landlord_confirmation_main_2">
                            ...
                            <span>您的活动已经提交</span>
                            <i>请耐心等待发起者确认，确认后我们通过消息或短信第一时间通知您</i>
                        </div>
                        <div class="Landlord_confirmation_main_3 hidden">
                            <div class="fl Landlord_confirmation_main_4">
                                <span class="f14 c999">房东 ：</span>
                                <a href="" class="Landlord_confirmation_main_4a">美丽的风铃</a>
                                <a href="" class="Landlord_confirmation_main_4a2">在线聊天</a>
                            </div>
                        </div>
                    </div>
                </div>
                <span class="Landord_confirmation_span">该活动附近的美宿推荐 :</span>
                        ...
                        <li>
                            <div class="Landord_confirmation_main6_list">
                                <div class="pr Landord_confirmation_main6_list2">
                                    <a href="">
                                        <img src="__IMG__/img68.jpg" />
                                    </a>
                                    <div class="pa Landord_confirmation_main6_list2_01">
                                        <i>￥<em>600</em></i><span>起</span>
                                    </div>
                                    <div class="Landord_confirmation_main6_list2_02 pa">
                                        <img src="__IMG__/Icon/img8.png">
                                    </div>
                                </div>
                                <div class="Landord_confirmation_main6_list_list3">
                                    <a href="">哈喽哈喽的粉色主题房间</a>
                                    <div class="hidden">
                                        <div class="fl Landord_confirmation_b">
                                            <img src="__IMG__/Icon/img10.png" />
                                            <span class="f14 c999"><em>188</em>条点评</span>
                                        </div>
                                        <div class="fr tr cur Landord_confirmation_a">
                                            <img src="__IMG__/Icon/img9.png" />
                                            <i class="f12 c999">28</i>
                                        </div>
                                    </div>
                                </div>
                            </div>
