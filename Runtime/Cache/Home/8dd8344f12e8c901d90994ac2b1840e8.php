...
<div class="wrap">
       <div class="activity_main">
           ...
           <a href="<?php echo U('Home/Note/index');?>">游记</a>
           <span>></span>
           <a href="<?php echo U('Home/Note/add');?>">发布游记</a>
       </div>
    ...
    <div class="wrap">
      <form action="<?php echo U('Home/Note/add');?>" method="post">
            ...
            <div class="travels3_main">
                ...
                <div class="travels3_main2">
                    ...
                    <div class="hidden travels3_main2_a"  id="content_0">
                        ...
                        <div class="fl travels3_main2_b img" id="img_0"><!-- <img src="/Public/Home/images/img42.jpg" /> --></div>
