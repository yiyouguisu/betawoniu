        ...
        <form action="{:U('Admin/Package/action')}" method="post" >
            <div class="table_list">
                ...
                <div class="p10">
                    ...
                    <if condition="authcheck('Admin/Package/packages')">
                        <button class="btn btn_submit mr10 " type="submit" name="submit" value="packages">批量包装</button>
                    </if>
                    <if condition="authcheck('Admin/Package/packagedones')">
                        <button class="btn btn_submit mr10 " type="submit" name="submit" value="packagedones">批量包装完成</button>
                    </if>
