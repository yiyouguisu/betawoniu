...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Question/index')}">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            <option value='0' <if condition=" $searchtype eq '0' "> selected</if>>题目</option>
        ...
        <form action="{:U('Admin/Question/action')}" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" > 
                                <if condition="authcheck('Admin/Question/edit')">
              <a href="{:U('Admin/Question/edit',array('id'=>$vo['id']))}" >修改</a> 
                <else/>
                 <font color="#cccccc">修改</font>
              </if> 
                            <if condition="authcheck('Admin/Question/delete')">
              <a href="{:U('Admin/Question/delete',array('id'=>$vo['id']))}"  class="del">删除</a> 
                <else/>
