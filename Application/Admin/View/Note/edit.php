...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/Note/edit')}">
                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>游记时间</th>
                                <td>
                                    <input type="text" name="begintime" class="input length_2 J_date" value="{$data.begintime}" style="width:120px;">
                                            ...
                                            <notempty name="imglist">
                                                <volist name="imglist" id="vo">
                                                    <li id='imglist{$i}'>
                                                        ...
                                                        <img src='{$vo.thumb}' style='width:210px;height:210px' title='移除' ondbclick="javascript:remove_div('imglist{$i}')">";
