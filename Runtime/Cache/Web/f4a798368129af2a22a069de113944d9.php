...
<div class="header center z-index112 pr f18">
      我的
      <div class="per_header pa"><a href="my-help2.html"><img src="/Public/Web/images/home_v1.jpg"></a><i>&nbsp;</i></div>
...
<div class="container">
      <div class="son_top pr f0">
              <div class="son_a vertical"><a href="my-person1.html"><img src="<?php echo ($data["head"]); ?>"></a></div>
              <div class="son_b vertical">
                    <div class="son_b1 f20"><?php echo ($data["nickname"]); ?></div>
                    <div class="son_b2 f14"><em>关注: 23</em><span>粉丝: 680</span></div>
              </div>
              <div class="set_a pa"><a href="person.html">个人主页<img src="/Public/Web/images/set_right.jpg"></a></div>
      </div> 
      
      <div class="set_b">
              <a href=""><div class="help_list">
               <div class="help_a"><img src="/Public/Web/images/set_a1.jpg"> 我要发布游记</div>
              </div></a> 
      </div>
      
      <div class="set_b">
              <a href="<?php echo U('Wx/My/couponInfo');?>"><div class="help_list">
               <div class="help_a"><img src="/Public/Web/images/set_a2.jpg"> 我的优惠券</div>
              </div></a> 
              <a href="my-review1.html"><div class="help_list">
               <div class="help_a"><img src="/Public/Web/images/set_a3.jpg"> 我的订单
              ...
              <a href="my-help.html"><div class="help_list">
      ...
      <div class="set_c">
         <div class="snail_d center trip_btn f16">
                  <a href="my-merchant3.html" class="snail_cut ">我要成为民宿主人</a>
         </div>
      </div>
