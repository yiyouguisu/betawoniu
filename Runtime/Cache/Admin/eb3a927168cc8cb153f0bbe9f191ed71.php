...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Note/index');?>">
        ...
        <form action="<?php echo U('Admin/Note/action');?>" method="post" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <!-- <td align="left" ><?php if(($vo['notetype']) == "1"): ?>游记<?php endif; if(($vo['notetype']) == "2"): ?>攻略<?php endif; ?></td> -->
                            ...
                            <td align="center" > 
                                ...
                                <?php if(authcheck('Admin/Note/delete')): ?><a href="<?php echo U('Admin/Note/delete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                                    <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                     <?php if(authcheck('Admin/Note/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?> 
                         <?php if(authcheck('Admin/Note/jinpins')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="jinpins">精品</button><?php endif; ?>
                      <?php if(authcheck('Admin/Note/unjinpins')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unjinpins">取消精品</button><?php endif; ?>
                    <?php if(authcheck('Admin/Note/pushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="pushs">推荐</button><?php endif; ?>
                      <?php if(authcheck('Admin/Note/unpushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unpushs">取消推荐</button><?php endif; ?>
                        <?php if(authcheck('Admin/Note/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
