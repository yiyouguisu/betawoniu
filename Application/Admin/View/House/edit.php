...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/House/edit')}">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" required="required"  name="uid" id="uid" value="{$data.uid}" />
                                    <input type="text" required="required"  class="input length_4 input_hd" placeholder="请选择游者" id="username" value="{$data.username}" readonly required>
                                    <input type="button" required="required"  class="button" value="选择" onclick="omnipotent('selectid','{:U('Admin/Member/select')}','请选择发布者',1,700,400)">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">主题</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="theme" required="required" class="input length_6 input_hd" placeholder="请输入民宿名称" id="theme" value="{$data.theme}">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">文章地址</th>
                            ...
                            <tr>
                                ...
                                <td><span class="must_red">*</span>
                                    <input type="text" required="required"  name="thumb" id="image" class="input length_5" value="{$data.thumb}" style="float: left" runat="server" ondblclick='image_priview(this.value);'>&nbsp; <input type="button" class="button" value="选择上传" id="uploadify"> <span class="gray"> 双击文本框查看图片</span>
                                </td>
                            </tr>
                            <!-- <tr>
                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='checkbox' name='couponsrule[]' value='1' <?php if(in_array(1, is_array($data["couponsrule"])?$data["couponsrule"]:explode(',',$data["couponsrule"]))): ?>checked<?php endif; ?>><span>全额抵用券</span></label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='checkbox' name='couponsrule[]' value='2' <?php if(in_array(2, is_array($data["couponsrule"])?$data["couponsrule"]:explode(',',$data["couponsrule"]))): ?>checked<?php endif; ?>><span>5折抵用券</span></label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='checkbox' name='couponsrule[]' value='3' <?php if(in_array(3, is_array($data["couponsrule"])?$data["couponsrule"]:explode(',',$data["couponsrule"]))): ?>checked<?php endif; ?>><span>8折抵用券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='checkbox' name='couponsrule[]' value='4' <?php if(in_array(4, is_array($data["couponsrule"])?$data["couponsrule"]:explode(',',$data["couponsrule"]))): ?>checked<?php endif; ?>><span>投票兑换券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='checkbox' name='couponsrule[]' value='5' <?php if(in_array(5, is_array($data["couponsrule"])?$data["couponsrule"]:explode(',',$data["couponsrule"]))): ?>checked<?php endif; ?>><span>邀请投票兑换券</span>
                                            </label>
                                        </li>
                                    </ul>
                                </td>
