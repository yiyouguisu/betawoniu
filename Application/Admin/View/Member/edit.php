...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/Member/edit')}">
                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                                <th>身份证号码</th>
                                <td><input type="text" name="idcard" class="input" id="idcard" value="{$data.idcard}" size="30">
                                </td>
                            </tr>
                            <tr>
                                <th>真实姓名</th>
