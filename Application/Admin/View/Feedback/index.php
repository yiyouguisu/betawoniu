                    ...
                    <div class="mb10">
                        <span class="mr20">
                            ...
                            <select class="select_2" name="searchtype">
                                ...
                                <option value='1' <if condition=" $searchtype eq '1' "> selected</if>>内容</option>
                                <option value='2' <if condition=" $searchtype eq '2' "> selected</if>>反馈人</option>
                    ...
                    <tbody>
                        <foreach name="data" item="vo">
                            <tr>
                                ...
                                <td align="center">
                                    <if condition="$vo['status'] eq 1"><font color="gray">待处理</font></if>
