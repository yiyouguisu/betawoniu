 ...
 <script type="text/javascript">
            ...
            <div class="my_comments_main fl">
                <div class="my_comments_main2">
                    <div class="my_comments_main2_head">
                        <span class="f24 c333">Ta的评论</span>
                    </div>
    ...
    <?php if(is_array($review)): $i = 0; $__LIST__ = $review;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['varname']) == "note"): ?><li>
                <div class="my_comments_main2_body_list hidden">
                    <a href="<?php echo U('Home/Note/show',array('id'=>$vo['value']));?>"><?php echo str_cut($vo['title'],20);?></a><i class="my_comments_i1">游记</i>
                    <!-- <input type="button" data-id="<?php echo ($vo["id"]); ?>" value="删除" /> -->
        ...
        <?php if(($vo['varname']) == "party"): ?><li>
                <div class="my_comments_main2_body_list hidden">
                    <a href="<?php echo U('Home/Party/show',array('id'=>$vo['value']));?>"><?php echo str_cut($vo['title'],20);?></a><i class="my_comments_i3">活动</i>
                    <!-- <input type="button" data-id="<?php echo ($vo["id"]); ?>" value="删除" /> -->
                    <p><?php echo ($vo["content"]); ?></p>
                    <span>发表于 <em><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></em></span>
                </div>
        ...
        <?php if(($vo['varname']) == "hostel"): ?><li>
                <div class="my_comments_main2_body_list hidden">
                    <a href="<?php echo U('Home/Hostel/show',array('id'=>$vo['value']));?>"><?php echo str_cut($vo['title'],20);?></a><i class="my_comments_i2">美宿</i>
                    <!-- <input type="button" data-id="<?php echo ($vo["id"]); ?>" value="删除" /> -->
                    <p><?php echo ($vo["content"]); ?></p>
                    <span>发表于 <em><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></em></span>
                </div>
        ...
        <?php if(($vo['varname']) == "trip"): ?><li>
                <div class="my_comments_main2_body_list hidden">
                    <a href="<?php echo U('Home/Trip/show',array('id'=>$vo['value']));?>"><?php echo str_cut($vo['title'],20);?></a><i class="my_comments_i4">行程</i>
                    <!-- <input type="button" data-id="<?php echo ($vo["id"]); ?>" value="删除" /> -->
                    <p><?php echo ($vo["content"]); ?></p>
                    <span>发表于 <em><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></em></span>
                </div>
...
<div class="activity_chang4 ajaxpagebar">
    ...
    <script type="text/javascript">
        function showBorrow(obj){
            ...
            $.get("<?php echo U('Home/Member/review');?>",p,function(d){
                if(d.status==1){
