...
<?php } ?>
        <div class="common-form">
            <form method="post" action="<?php echo U('Admin/Note/add');?>">
                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>游记时间</th>
                                <td>
                                    <input type="text" name="starttime" class="input length_2 J_date" value="<?php echo ($data["begintime"]); ?>" style="width:120px;">
                                    ...
                                    <fieldset class="blue pad-10">
                                        ...
                                        <ul id="albums" class="picList">
                                            <?php if(!empty($imglist)): if(is_array($imglist)): $i = 0; $__LIST__ = $imglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id='imglist<?php echo ($i); ?>'>
                                                        ...
                                                        <img class="img" src='<?php echo ($vo["thumb"]); ?>' style='width:210px;height:210px' title='移除' >
