...
<?php } ?>
        ...
        <form action="<?php echo U('Admin/Ad/typelistorder');?>" method="post" >
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                        <?php if(authcheck('Admin/Ad/typelistorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?> 
