 ...
 <script type="text/javascript">
	...
	<div class="wrap">
	   <div class="activity_main">
	       <a href="/">首页</a>
	       <span>></span>
	       <a href="<?php echo U('Home/Trip/index');?>">公开行程</a>
	   </div>
	</div>
       ...
       <div class="activity_main2 hidden">
           <div class="fl Open_stroke_a">
               <div class="Open_stroke_r_top">
                   <a href="<?php echo U('Home/Trip/index');?>" class="Open_stroke_r_topa1">公开行程</a>
                   <a href="<?php echo U('Home/Trip/mytrip');?>">我定制的行程</a>
               </div>
                   ...
                   <ul class="Open_stroke_r_bottom_ul">
                      <?php if(is_array($trip)): $i = 0; $__LIST__ = $trip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                           <a href="<?php echo U('Home/Trip/show',array('id'=>$vo['id']));?>">
                               ...
                               <i>时间 :  <em><?php echo (date("Y年m月d日",$vo["starttime"])); ?> - <?php echo (date("Y年m月d日",$vo["endtime"])); ?></em></i>
                           </a>
           ...
           <div class="fr activity_main2_02">
               <!-- <div class="Open_stroke_l_top">
                   <a href="">
                       <img src="/Public/Home/images/img100.jpg" />
                   </a>
               </div> -->
               <div class="Open_stroke_main">
                       ...
                       <ul class="activity_main2_02-1_ul">
                          <?php if(is_array($hotnote)): $i = 0; $__LIST__ = $hotnote;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                  <div class="activity_main2_02-1_list pr">
                                      <img class="pic" data-original="<?php echo ($vo["thumb"]); ?>" src="/Public/Home/images/default.jpg" width="339px" height="213px" onclick="window.location.href='<?php echo U('Home/Note/show',array('id'=>$vo['id']));?>'" />
                                      <span><?php echo str_cut($vo['title'],10);?></span>
                   ...
                   <a href="<?php echo U('Home/Note/index',array('type'=>1));?>">
                       点击查看更多游记...
                   </a>
               </div>
           </div>
