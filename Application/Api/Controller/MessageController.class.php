    ...
    */
    public function message(){
        ...
        if($uid==''||$p==''||$num==''){
            ...
            $data=M("message")->where(array('r_id'=>$uid,'isdel'=>'0'))->order(array('id'=>"desc"))->field("id,title,content,status,varname,value,inputtime")->page($p,$num)->select();
            if($data){
    ...
    public function show(){
        ...
        if($uid==''||$mid==''){
            ...
            $data=M("message")->where(array('id'=>$mid))->field("id,title,content,status,varname,value,inputtime")->find();
            if($data){
                exit(json_encode(array('code'=>200,'msg'=>"Load success!",'data' => $data)));
            }else{
