...
<div class="container">
     <div class="son_top pr f0">
              <div class="son_a vertical"><img id='head' src="<?php echo ($data["head"]); ?>"></div>
              <div class="son_b vertical">
                    <div class="son_b1 f18"><?php echo ($data["nickname"]); ?></div>
              </div>
              <div class="set_a  xm_click pa"><a href="javascript:;">更换头像<img src="/Public/Web/images/set_right.jpg"></a></div>
      </div> 
      <form id='form' action="<?php echo U('Web/Member/certification');?>" method="post">
          <div class="act_c">
                <div class="lu_b">
...
<!--           <div class="hm_c">反面 :</div>
          <div class="hm_d">
                <ul>
                    ...
                    <li><img src="/Public/Web/images/hm_c2.jpg" id='fan'></li>
                </ul>
          </div> -->
...
<!--                    <div class="fish_list">
                   ...
                   <div class="fish_list">    
                       <div class="snail_d center f16">
                            <!-- <a href="" class="snail_cut"><img src="/Public/Web/images/xm_a2.jpg">从相册选择</a> -->
                            <form id= "uploadForm2" enctype="multipart/form-data" method="post"  onchange="doUpload2()" />  
                              <div class="snail_d center f16 pr">
                                    <a class="snail_cut"><img src="/Public/Web/images/xm_a2.jpg">从相册选择</a>
