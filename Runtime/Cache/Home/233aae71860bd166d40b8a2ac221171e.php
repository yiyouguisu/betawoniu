            ...
            <div class="fl order_main2_2">
                <div class="order_main2_201">
                    ...
                    <div class="order_main2_201_list">
                        <a href="<?php echo U('Home/Member/myorder_hostel');?>" class="order_list_a1">美宿</a>
                        <a href="<?php echo U('Home/Member/myorder_party');?>" class="">活动</a>
                    </div>
                ...
                <div class="hidden">
                    <div class="fl order_main3_list">
                        <a href="<?php echo U('Home/Room/show',array('id'=>$vo['productinfo']['rid']));?>">
                            <img src="<?php echo ($vo["productinfo"]["thumb"]); ?>" style="width:142px;height:88px" />
                        </a>
                    </div>
...
<div class="activity_chang4 ajaxpagebar">
    ...
    <script type="text/javascript">
        ...
        function showBorrow(obj){
            ...
            $.get("<?php echo U('Home/Member/myorder_hostel');?>",p,function(d){
                if(d.status==1){
