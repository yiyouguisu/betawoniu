                    ...
                    <?php if(is_array($hotnote)): $i = 0; $__LIST__ = $hotnote;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <div class="activity_main2_02-1_list">
                                <div class="travels_main_x pr">
                                   <img class="pic" data-original="<?php echo ($vo["thumb"]); ?>" src="/Public/Home/images/default.jpg" style="width:339px;height:213px" onclick="window.location.href='<?php echo U('Home/Party/show',array('id'=>$vo['id']));?>'" />
    ...
    $(function () {
        ...
        $(".zanbg1").live("click",function(){
            ...
            if(!uid){
              alert("请先登录！");
                var p={};
                p['url']="/index.php/Home/Party/index/type/2.html";
