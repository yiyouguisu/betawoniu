...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post"  action="{:U('Admin/Product/pedit')}">
                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <ul class="switch_list cc ">
                                    <li>
                                        <label><input type='radio' name='type' value='1' <if condition="$data['type'] eq 1">checked</if>><span>一般商品</span></label>
                                    </li>
                                    <li>
                                        <label><input type='radio' name='type' value='2' <if condition="$data['type'] eq 2">checked</if>><span>团购商品</span></label>
                                    </li>
                                    <li>
                                        <label><input type='radio' name='type' value='3' <if condition="$data['type'] eq 3">checked</if>><span>预购商品</span></label>
                                    </li>
                                    <li>
                                        <label><input type='radio' name='type' value='4' <if condition="$data['type'] eq 4">checked</if> ><span>称重商品</span></label>
                                    </li>
                                  </ul>
                                </td>
                            </tr>
                            ...
                            <tr class="product5" style="display:none;">
                                <th>购买基数</th>
                                <td>
                                    <input type="number" name="step" class="input input_hd" placeholder="请输入产品购买基数" id="step" value="{$data.step}">
                                </td>
                            </tr>
                            <tr>
                                <th>产品库存</th>
                                ...
                                <td><span class="must_red">*</span>
                                    <select name="storehouse">
                                        ...
                                        <volist name="storehouse" id="vo">
                                            <option value="{$vo.id}"  <if condition="$data['storehouse'] eq $vo['id']">selected</if>>{$vo.title}</option>
                                        </volist>
                                    </select>   
                                </td>
                            </tr>
