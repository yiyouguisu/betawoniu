...
<include file="Common:Head" /><body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Order/errororder')}">
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="8%"  align="center" >包装状态</td>
                            ...
                            <td width="14%" align="center" >管理操作</td>
                        </tr>
                    </thead>
                    <tbody>
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                       <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" > 
                                <if condition="$vo['error_status'] eq 1">
                                    <a href="{:U('Admin/Order/doerror',array('orderid'=>$vo['orderid']))}">异常审核</a></br>
                                </if>
                                <if condition="$vo['error_status'] eq 2">
                                    <empty name="vo['relationorderid']">
                                        ...
                                        <else />
                                        <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Order/show',array('orderid'=>$vo['relationorderid']))}','查看售后订单详情',1,700,400)">查看售后订单</a></br>
                                    </empty>
                                </if>
                                <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Order/feedbacklog',array('orderid'=>$vo['orderid']))}','处理记录',1,700,400)">处理记录</a></br>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <form method="post" action="{:U('Admin/Orderexcel/excel')}">
                            ...
                            <input type="hidden"  name="error_status" value="1" >
