        ...
        <div class="addressList">
            <volist name="addlist" id="vo">
             ...
             <tr>
                 ...
                 <eq name="addurl" value="0">
                     <td onclick="javascript:location.href='{$vo.editurl}'">{$vo.area}<br />{$vo.address}</td>
                 ...
                 <eq name="addurl" value="1">
                     <td onclick="javascript:location.href='{$vo.addressurl}'">{$vo.area}<br />{$vo.address}</td>
                 ...
                 <eq name="addurl" value="2">
                     <td onclick="javascript:location.href='{$vo.fapiaourl}'">{$vo.area}<br />{$vo.address}</td>
