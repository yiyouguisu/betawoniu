...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/apply/realname');?>">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            ...
                            <option value='1' <?php if( $searchtype == '1' ): ?>selected<?php endif; ?>>身份证号码</option>
        ...
        <form action="<?php echo U('Admin/apply/action');?>" method="post" >
            ...
            <?php if(($vo['status']) == "1"): if(authcheck('Admin/apply/realnamereview')): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/apply/realnamereview',array('id'=>$vo['id']));?>','审核',1,700,400)">审核</a>
                <?php else: ?>
                 <font color="#cccccc">审核</font><?php endif; endif; ?>
                            <?php if(authcheck('Admin/apply/realnamedelete')): ?><a href="<?php echo U('Admin/apply/realnamedelete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                        ...
                        <?php if(authcheck('Admin/apply/realnamedel')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="realnamedel">删除</button><?php endif; ?>
