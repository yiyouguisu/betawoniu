                        ...
                        <div class="Landlord_confirmation_main_3 hidden">
                            <div class="fl Scheduled_finish_main1">
                                <div>
                                    ...
                                    <i class="f14 c333">{$data.starttime|date="Y年m月d日",###}--{$data.endtime|date="Y年m月d日",###}</i>
                                </div>
                                <div>
                                    <span class="f14 c999">活动人数：</span>
                                    <i class="f14 c333">{$data.start_numlimit|default="0"}-{$data.end_numlimit|default="0"}人</i>
                                </div>
                                <div>
                                    <span class="f14 c999">活动地址：</span>
                                    <i class="f14 c333">{:getarea($data['area'])}{$data.address} </i>
                                </div>
                            </div>
