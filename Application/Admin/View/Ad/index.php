...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="post" action="{:U('Admin/Ad/index')}">
                ...
                <div class="mb10">
                    <span class="mr20">
                        ...
                        <select class="select_2" name="status" style="width:70px;">
                            ...
                            <option value="1" <if condition=" $Think.post.status eq '1'"> selected</if>>审核</option>
