...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/apply/houseowner');?>">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            <option value='0' <?php if( $searchtype == '0' ): ?>selected<?php endif; ?>>真实姓名</option>
                            <option value='1' <?php if( $searchtype == '1' ): ?>selected<?php endif; ?>>美宿名称</option>
                            <option value='2' <?php if( $searchtype == '2' ): ?>selected<?php endif; ?>>美宿地址</option>
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="10%" align="center" >美宿名称</td>
                            <td width="10%" align="center" >美宿地址</td>
                            <td width="15%" align="center">证件照</td>
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="left" ><?php echo getuserinfo($vo['uid']);?></td>
                            <td align="center" ><?php echo ($vo["realname"]); ?></td>
                            <td align="center" ><?php echo ($vo["housename"]); ?></td>
                            <td align="center" ><?php echo ($vo["address"]); ?></td>
                            <td align="center"><img src="<?php echo ($vo["thumb"]); ?>" ondblclick='image_priview(this.src);' width="80px" height="80px"></td>
                            <td align="center" ><?php echo getreviewstatus($vo['status']);?></td>
                            <td align="center" ><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></td>
                            <td align="center" > 
                               
            <?php if(($vo['status']) == "1"): if(authcheck('Admin/apply/houseownerreview')): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/apply/houseownerreview',array('id'=>$vo['id']));?>','审核',1,700,400)">审核</a>
                <?php else: ?>
                 <font color="#cccccc">审核</font><?php endif; endif; ?>
                            <?php if(authcheck('Admin/apply/houseownerdelete')): ?><a href="<?php echo U('Admin/apply/houseownerdelete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                        ...
                        <?php if(authcheck('Admin/apply/houseownerdel')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="houseownerdel">删除</button><?php endif; ?>
