...
function rongCreateMessage(messageContent){
    ...
    str='<div class="bjy-cbh-one '+messageContent['direction']+'"><div class="bjy-cbhl-head"><img class="bjy-cbhla-img" src="'+messageContent['head']+'">'+approveImg+'<div class="bjy-cbhla-triangle"></div></div><div class="bjy-cbhl-content">'+messageContent['content']+'</div></div>';
    return str;
}
...
function rongCreateFriendInfo(userInfo) {
    ...
    var str='<div class="bjy-fl-one" data-edu="" data-head="'+userInfo['head']+'" data-username="'+userInfo['username']+'" data-uid="'+userInfo['id']+'"><div class="bjy-flo-head"><img class="bjy-floa-img" src="'+userInfo['head']+'">'+approveImg+countStr+'</div><ul class="bjy-flo-info"><li class="bjy-flo-username">'+userInfo['username']+'<span class="bjy-flou-time">'+userInfo['date']+'</span></li><li class="bjy-flo-school"></li></ul></div>';
    return str;
}
...
$(function(){
    ...
    $('.bjy-friend-list').on('click', '.bjy-fl-one', function(event) {
        ...
        if (!$(this).hasClass('bjy-flo-checked')) {
            ...
            $('#bjy-chat-modal .bjy-cbh-send').attr('data-head',userInfo['head']);
            // 设置聊天框title
