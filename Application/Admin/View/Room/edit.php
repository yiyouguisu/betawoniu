...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/Room/edit')}">
                                ...
                                <td>
                                    ...
                                    <select class="select_2" name="roomtype">
                                        ...
                                        <volist name="bedcate" id="vo">
                                            <option value="{$vo.id}" <if condition="$vo['id'] eq $data['roomtype']">selected</if>>{$vo.catname}</option>
                                         </volist>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <volist name="roomcate" id="vo">
                                            <li>
                                                <label><input type='checkbox' name='support[]' value='{$vo.id}' <in name="vo['id']" value="$data['support']">checked</in> /><span>{$vo.catname}</span></label>
                                            </li>
                                        </volist>
                                    </ul>
                                </td>
