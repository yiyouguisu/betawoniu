...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Product/book')}">
        ...
        <form action="{:U('Admin/Product/paction')}" method="post" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="12%" align="left" >产品名称</td>
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" >{$vo.standard}{:getunit($vo['unit'])}</td>
              ...
              <a href="{:U('Admin/Product/pedit',array('id'=>$vo['id']))}" >修改</a>  |
              <a href="{:U('Admin/Product/pdelete',array('id'=>$vo['id']))}"  class="del">删除</a>  |
              <a href="{:U('Admin/Product/pbookorder',array('id'=>$vo['id']))}" >查看订单</a> 
