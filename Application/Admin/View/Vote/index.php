...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Vote/index')}">
        ...
        <form action="{:U('Admin/Vote/action')}" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" > 
                                <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Vote/choujiang',array('id'=>$vo['id']))}','抽奖',1,500,220)">抽奖</a>
                                <!--<a href="{:U('Admin/Vote/choujiang',array('id'=>$vo['id']))}">抽奖</a> -->
                                <a href="{:U('Admin/Vote/voteresult',array('id'=>$vo['id']))}">查看结果</a>
              <a href="{:U('Admin/Vote/edit',array('id'=>$vo['id']))}" >修改</a> 

              <a href="{:U('Admin/Vote/delete',array('id'=>$vo['id']))}"  class="del">删除</a> 
<!-- <a href="{:U('Admin/Vote/revote',array('id'=>$vo['id']))}"  >重新抽</a> -->
 <a href="{:U('Admin/Vote/postsms',array('vaid'=>$vo['id']))}"  >短信群发</a>                               
