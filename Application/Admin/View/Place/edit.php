...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form name="myform" id="myform" action="{:U('Admin/Place/edit')}" method="post" enctype="multipart/form-data">
                ...
                <div class="table_full">
                    <table width="100%" class="table_form ">
                        <tr id="normal_add">
                            <th width="200">名称：</th>
                            <td>
                                <input type="text" name="title" id="title" class="input" value="{$data.title}"></td>
                        </tr>
                        <tr>
                            <th>显示排序：</th>
                            <td>
