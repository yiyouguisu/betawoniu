 ...
 <body class="back-f1f1f1">
    <div class="header center z-index112 pr f18 fix-head">
        ...
        <div class="head_go pa">
            <a href="{:U('Order/party_order_detail')}?orderid={$data.orderid}">
    ...
    <div class="container padding_0" style="margin-top:6rem">
        ...
        <form action="{:U('Order/editpartyconfirm')}" method="post" id='form' onsubmit="return checkform();">
            ...
            <div class="we_a" style="margin-bottom:6rem">
                ...
                <div class="we_b">
                    ...
                    <div class="we_b2 center">
                        <input type="number" name='num' class="we_text" value="{$lcount}" readonly>人
                    </div>
                ...
                <div class="we_d">
                    <div class="lu_b">
                        <input type="text" name="realname" class="lu_text main-partner" value="{$data.realname}" placeholder="真实姓名 :">
                    </div>
                    <div class="lu_b">
                        <input type="text" name="phone" class="lu_text main-partner" value="{$data.phone}" placeholder="电话号码 :">
                    </div>
                    <div class="lu_b">
                        <input type="text" name="idcard" class="lu_text main-partner" value="{$data.idcard}" placeholder="身份证号码 :">
                    </div>
                </div>
                ...
                <volist name="partners" id="partner">
                  <div class="name_list" id="partner_{$partner.phone}">
                    ...
                    <div class="name_a">
                      <input type="hidden" class="link_id" value="">
                      <input class="partners" type="hidden" name="partners[]" value="{$partner.realname},{$partner.phone},{$partner.idcard}">
                      <input type="button" data-name="{$partner.realname}" data-linkId="" data-phone="{$partner.phone}" data-idcard="{$partner.idcard}" class="name_btn edit_partner" data-origin="#partner_{$partner.phone}" value="编辑">
...
<script>
    ...
    function countActPeople() {
        var count = $('.we_c').find('div.name_list').length + 1;
        return count;
    }
...
<script>
  ...
  (function() {
    ...
    (function() {
      ...
      $('.we_c').find('input.del_partner').click(function(evt) {
        evt.preventDefault();
