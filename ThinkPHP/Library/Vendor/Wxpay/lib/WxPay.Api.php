...
class WxPayApi
{
	...
	public static function wapOrderQuery($inputObj, $timeOut = 6)
	{
		$url = "https://api.mch.weixin.qq.com/pay/orderquery";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{		
        ...
        if($useCert == true){
            ...
            curl_setopt($ch,CURLOPT_SSLCERT, VENDOR_PATH . "WxPay/cert/apiclient_cert.pem");
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
            curl_setopt($ch,CURLOPT_SSLKEY, VENDOR_PATH . "WxPay/cert/apiclient_key.pem");
        }
        //post提交方式
