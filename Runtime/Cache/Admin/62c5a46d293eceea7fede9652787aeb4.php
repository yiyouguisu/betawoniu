...
<?php } ?>
        ...
        <form id="myform" method="post" enctype="multipart/form-data" action="<?php echo U('Admin/Config/service');?>">
            ...
            <div class="J_tabs_contents">
                ...
                <div class="tba">
                    <div class="table_full">
                        <textarea name="use_service" id="use_service"><?php echo ($Site["use_service"]); ?></textarea>
                    </div>
                </div>
                <div class="tba">
                    <div class="table_full">
                        <textarea name="instruction" id="instruction"><?php echo ($Site["instruction"]); ?></textarea>
                    </div>
                </div>
                <!-- <div class="tba">
                    <div class="table_full">
                ...
                <div class="tba">
                    <div class="table_full">
                        <textarea name="withdrawrule" id="withdrawrule"><?php echo ($Site["withdrawrule"]); ?></textarea>
                    </div>
                </div>
                <div class="tba">
                    <div class="table_full">
                        <textarea name="tripinfo" id="tripinfo"><?php echo ($Site["tripinfo"]); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="btn_wrap">
