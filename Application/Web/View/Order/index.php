    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function changeimg(thisindex) {
                switch (thisindex) {
                    case 1:
                        $("#orderHead ul li").eq(0).find('img').attr('src', '__IMG__/icon_whole_default.png');
                        $("#orderHead ul li").eq(1).find('img').attr('src', '__IMG__/icon_payment.png');
                        $("#orderHead ul li").eq(2).find('img').attr('src', '__IMG__/icon_package_default.png');
                        $("#orderHead ul li").eq(3).find('img').attr('src', '__IMG__/icon_receiving_default.png');
                        $("#orderHead ul li").eq(4).find('img').attr('src', '__IMG__/icon_evaluation_default.png');
                        break;
                    case 2:
                        $("#orderHead ul li").eq(0).find('img').attr('src', '__IMG__/icon_whole_default.png');
                        $("#orderHead ul li").eq(1).find('img').attr('src', '__IMG__/icon_payment_default.png');
                        $("#orderHead ul li").eq(2).find('img').attr('src', '__IMG__/icon_package.png');
                        $("#orderHead ul li").eq(3).find('img').attr('src', '__IMG__/icon_receiving_default.png');
                        $("#orderHead ul li").eq(4).find('img').attr('src', '__IMG__/icon_evaluation_default.png');
                        break;
                    case 3:
                        ...
                        $("#orderHead ul li").eq(1).find('img').attr('src', '__IMG__/icon_payment_default.png');
                        $("#orderHead ul li").eq(2).find('img').attr('src', '__IMG__/icon_package_default.png');
                        $("#orderHead ul li").eq(3).find('img').attr('src', '__IMG__/icon_receiving.png');
                        $("#orderHead ul li").eq(4).find('img').attr('src', '__IMG__/icon_evaluation_default.png');
                        break;
                    case 4:
                        $("#orderHead ul li").eq(0).find('img').attr('src', '__IMG__/icon_whole_default.png');
                        ...
                        $("#orderHead ul li").eq(2).find('img').attr('src', '__IMG__/icon_package_default.png');
                        $("#orderHead ul li").eq(3).find('img').attr('src', '__IMG__/icon_receiving_default.png');
                        $("#orderHead ul li").eq(4).find('img').attr('src', '__IMG__/icon_evaluation.png');
                        break;
                }
            }
            ...
            $("#orderHead").on('click', '.nomal', function () {
                ...
                if ($(this).index() == 0) {
                    ...
                    //待付款
                    location.href = "{:U('Web/Order/index')}?status=waitpay";
                }
                else if ($(this).index() == 2) {
                    //待包装
                    location.href = "{:U('Web/Order/index')}?status=waitpackage";
                }
                    ...
                    //待评价
                    location.href = "{:U('Web/Order/index')}?status=waitevaluate ";
                }
            })


            $("#thelist").on('click', '.go_pay', function () {
                var orderid = $(this).parent().parent().find('.gourl').attr('id');
                console.log($(this).parent().find('#pays').size())
                open($(this).parent().find('#pays'));
                //alert(orderid);
                //location.href = "{:U('Web/Order/show')}?id=" + orderid+"&pay=trues";
            })
            ...
            $("#thelist").on('click', '.goods', function () {
                ...
                location.href = "{:U('Web/Order/show')}?id=" + id;
            })

            $(".r").click(function () {
                location.href = "{:U('Web/Order/logistics')}";
            })
        ...
        template_all += '        <buttom class="order go_pay" {isgopay} >去支付</buttom>                          ';
        template_all += '        <buttom class="order goeval" {iseval} onclick="goeval()">去评价</buttom>                          ';
        template_all += '    </div>                                                                                   ';
        template_all += '</div>                                                                                       ';

        template_smm = '        <div class="goodsItem">                                                              ';
        template_smm += '            <div class="image"><img alt="" src="__ROOT__{pimg}" /></div>                  ';
            ...
            $.each(response, function (key, value) {
                ...
                $.each(value.productinfo, function (key, value) {
                    ...
                    if (value.product_type == '1') {
                        ...
                        template_items = template_items.replace('{typepng}', "__IMG__/orderStyleTh.png");
                    } else if (value.product_type == '2') {
                        template_items = template_items.replace('{widthstatus}', "display:none");
                        template = template.replace('{yustyle}', "style='display:none'");
                        template_items = template_items.replace('{typepng}', "__IMG__/orderStyleTg.png");
                    } else if (value.product_type == '3') {
                        template_items = template_items.replace('{widthstatus}', "display:none");
                        template = template.replace('{noyustyle}', "style='display:none'");
                        template_items = template_items.replace('{typepng}', "__IMG__/orderStyleYg.png");
                    } else if (value.product_type == '4') {
                        template = template.replace('{yustyle}', "style='display:none'");
                        template_items = template_items.replace('{typepng}', "__IMG__/orderStyleCz.png");
                        if (value.isweigh == '0') {
                            template_items = template_items.replace('{gstatus}', "待称重");
                        ...
                        template = template.replace('{yustyle}', "style='display:none'");
                        template_items = template_items.replace('{widthstatus}', "display:none");
                        template_items = template_items.replace('{typepng}', "__IMG__/orderStyleQY.png");
                    }
...
<body>
    ...
    <div id="orderHead" class="orderHead" style="margin-top:0px">
        <ul>
            <li class="hover">
                <div class="image">
                    <img alt="" src="__IMG__/icon_whole.png" />
                </div>
                <div class="title">全部订单</div>
            </li>
            <li class="nomal">
                <div class="image">
                    <img alt="" src="__IMG__/icon_payment_default.png" />
                    <if condition="($waitpay neq '0') AND ($waitpay neq '')">
                    <span>{$waitpay}</span>
                    </if>
                </div>
            ...
            <li class="nomal">
                <div class="image">
                    <img alt="" src="__IMG__/icon_package_default.png" />
                    <if condition="($waitpackage neq '0') AND ($waitpackage neq '')">
                    <span>{$waitpackage}</span>
                    </if>
                </div>
            ...
            <li class="nomal">
                <div class="image">
                    <img alt="" src="__IMG__/icon_receiving_default.png" />
                    <if condition="($waitconfirm neq '0') AND ($waitconfirm neq '')">
                    <span>{$waitconfirm}</span>
                    </if>
                </div>
            ...
            <li class="nomal">
                <div class="image">
                    <img alt="" src="__IMG__/icon_evaluation_default.png" />
                    <if condition="($waitevaluate neq '0') AND ($waitevaluate neq '')">
                    <span>{$waitevaluate}</span>
                    </if>
                </div>
