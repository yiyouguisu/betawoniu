                    ...
                    <div class="table_full">
                        <table cellpadding=0 cellspacing=0 width="100%" class="table_form">
                            <tr>
                                ...
                                <td><input type="text" class="input" name="smsUser" value="{$Site.smsUser}" size="40"></td>
                            </tr>
                            <tr>
                                <th width="140">亿美软通密码:</th>
                                <td><input type="text" class="input" name="smsPass" value="{$Site.smsPass}" size="40"></td>
                            </tr>
                            <tr>
                                <th width="140">亿美软通营销帐号:</th>
                                <td><input type="text" class="input" name="bsmsUser" value="{$Site.bsmsUser}" size="40"></td>
                            </tr>
                            <tr>
                                <th width="140">亿美软通营销密码:</th>
                                <td><input type="text" class="input" name="bsmsPass" value="{$Site.bsmsPass}" size="40"></td>
                            </tr>
                    ...
                    <div class="table_full">
                        <table cellpadding=0 cellspacing=0 width="100%" class="table_form">
                            <tr>
                                ...
                                <td><input type="text" class="input" name="rongyunUser" value="{$Site.rongyunUser}" size="40"></td>
                            </tr>
                            <tr>
                                <th width="140">融云接口密码:</th>
                                <td><input type="text" class="input" name="rongyunPass" value="{$Site.rongyunPass}" size="40"></td>
                            </tr>
