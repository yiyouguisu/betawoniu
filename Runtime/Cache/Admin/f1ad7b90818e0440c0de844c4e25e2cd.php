...
<?php } ?>
        ...
        <form method="post" action="<?php echo U('Admin/Ad/index');?>">
                ...
                <div class="mb10">
                    <span class="mr20">
                        ...
                        <select class="select_2" name="status" style="width:70px;">
                            ...
                            <option value="1" <?php if( $_POST['status']== '1'): ?>selected<?php endif; ?>>审核</option>
                            <option value="0" <?php if( $_POST['status']== '0'): ?>selected<?php endif; ?>>未审核</option>
                        </select>
        ...
        <form action="<?php echo U('Admin/Ad/action');?>" method="post">
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                    <?php if(authcheck('Admin/Ad/edit')): ?><a href="<?php echo U('Admin/Ad/edit',array('id'=>$vo['id']));?>">修改</a>
                                        <?php else: ?>
                                        <font color="#cccccc">修改</font><?php endif; ?>
                                    <?php if(authcheck('Admin/Ad/delete')): ?><a href="<?php echo U('Admin/Ad/delete',array('id'=>$vo['id']));?>" class="del">删除</a>
                                        <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <?php if(authcheck('Admin/Ad/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder">排序</button><?php endif; ?>
                    <?php if(authcheck('Admin/Ad/review')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="review">审核</button><?php endif; ?>
                    <?php if(authcheck('Admin/Ad/unreview')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unreview">取消审核</button><?php endif; ?>
                    <?php if(authcheck('Admin/Ad/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
                </div>
            </div>
        </form>
    </div>
