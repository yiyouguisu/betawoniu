                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='1' <if condition="$data['type'] eq '1' ">checked</if>><span>全额抵用券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='2' <if condition="$data['type'] eq '2' ">checked</if>><span>5折抵用券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='3' <if condition="$data['type'] eq '3' ">checked</if>><span>8折抵用券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='4' <if condition="$data['type'] eq '4' ">checked</if>><span>投票兑换券</span>
                                            </label>
                                        </li>
                                        <li style="width: 130px;">
                                            <label>
                                                <input type='radio' name='type' value='5' <if condition="$data['type'] eq '5' ">checked</if>><span>邀请投票兑换券</span>
                                            </label>
                                        </li>
                                    </ul>
                                </td>
                                ...
                                <td>
                                    <ul class="switch_list cc morelist">
                                        <volist name="shop" id="vo">
                                            <li style="width: 130px;">
                                                <label>
                                                    <input type='checkbox' name='hid[]' value='{$vo.id}'  <eq name="vo['ischeck']" value="1">checked</eq>><span>{$vo.title}</span></label>
                                            </li>
                                        </volist>
                                    </ul>
                                            ...
                                            success: function (data) {
                                                ...
                                                if (data != null && data.length > 0) {
                                                    for (var i = 0; i < data.length; i++) {
                                                        ...
                                                        ahtml += "<label>";
                                                        if (data[i].ischeck == 1) {
                                                            ahtml += "<input type='checkbox' name='hid[]' value='" + data[i].id + "' checked><span>" + data[i].title + "</span></label>";
                                                        } else {
