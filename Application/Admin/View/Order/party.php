...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Order/party')}">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> 
                    <span class="mr20">
                        ...
                        <input type="hidden" class="input length_2" name="aid" style="width:200px;" value="{$Think.get.aid}">
                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" >{$vo.orderid}<a href="{:U('Admin/Order/bookmember',array('type'=>'party','orderid'=>$vo['orderid']))}" class="info"><img src="/Public/Admin/images/info.png" style="width: 20px;display: inline-block;margin-bottom: -5px;"></a></td>
