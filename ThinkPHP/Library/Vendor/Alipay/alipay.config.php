...
$alipay_config['partner']		= '2088221764898885';

//收款支付宝账号，以2088开头由16位纯数字组成的字符串，一般情况下收款账号就是签约账号
$alipay_config['seller_id']	= '3221586551@qq.com';
...
$alipay_config['notify_url'] = "http://beta.woniu.ccjjj.net/Alipay/notify_url.php";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] = "http://beta.woniu.ccjjj.net/Alipay/return_url.php";
