...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/Holiday/edit')}">
                    ...
                    <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td>时间</th>
                                <td>
                                    <input type="text" name="startdate" class="input length_2 J_date startdate" value="{$data.startdate|date='Y-m-d',###}" style="width:120px;" required>
                                    <input type="text" name="days" class="input length_2 input_hd" placeholder="天数" id="days" value="{$data.days}" required>
                                    <input type="text" class="input length_2 J_date enddate" name="enddate" value="{$data.enddate|date='Y-m-d',###}" style="width:120px;" required>
                                </td>
                            </tr>
                            <tr>
                                <td>状态:</td>
