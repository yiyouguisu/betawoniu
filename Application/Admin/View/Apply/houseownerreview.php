                ...
                <div class="table_full">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>证件照</th>
                                <td><img src="{$data.thumb}" ondblclick='image_priview(this.src);' width="200px" height="200px"></td>
                            </tr>
                    ...
                    <form class="J_ajaxForm" method="post" action="{:U('Admin/Apply/houseownerreview')}">
                         <div class="bk10"></div>
