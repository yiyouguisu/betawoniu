...
function getuserinfo($uid){
    ...
    return "<a href=\"javascript:;\" onClick=\"omnipotent('selectid','" . U('Admin/Member/details',array('id'=>$user['id'])) . "','". $user['nickname'] ."的详细情况',1,800,450)\">" . $user['nickname'] . "</a>";
}
...
function getorderstatus($status){
    ...
    switch ($status) {
        ...
        case '3':
            # code...
            $data="<span style=\"color: gray\">订单已取消</span>";
            break;
        case '4':
            # code...
            $data="<span style=\"color: green\">订单已完成</span>";
            break;
        case '5':
            # code...
            $data="<span style=\"color: green\">订单审核失败</span>";
            break;
        case '6':
            # code...
            $data="<span style=\"color: green\">订单已关闭</span>";
            break;
    }
    return $data;
}
...
function getpaystyle($orderid){
    ...
    if($order['paytype']==1){
        ...
        $str="<span style=\"color: green\">(银联)</span>";
    }else{
        $str="<span style=\"color: green\">(待支付)</span>";
    }
