...
<div class="wrap">
       <div class="activity_main">
           ...
           <span>></span>
           <a href="{:U('Home/Note/edit',array('id'=>$data['id']))}">修改游记</a>
       </div>
    ...
    <div class="wrap">
      <form action="{:U('Home/Note/edit')}" method="post">
        <div class="activity2_main2">
            ...
            <div class="activity2_main2_01">
                ...
                <div class="activity2_main2_text1 middle">
                    <i>开始时间 :</i>
                    <input id="d5221" class="J_date starttime" type="text" name="begintime" value="{$data.begintime}" required/>
                </div>
                <i><input type="text" id="days" name="days" value="{$data.days}" style="    width: 20px;border: none;color: #21a7bb;">天</i>
                <div class="activity2_main2_text1 middle">
                    <i>结束时间 :</i>
            ...
            <div class="activity2_main2_01">
                ...
                <div class="activity2_main2_x pr middle">
                    <span class="notehostel">
                        <eq name="notehostelnum" value="1">
                            {$notehosteltitle}
                            <else />
                            您选择了多家美宿
                        </eq>
                    ...
                    <div class="pa activity2_main2_y hide">
                        <ul class="activity2_main2_y_ul">
                            <volist name="hostel" id="vo">
                                <li data-id="{$vo.id}" <eq name="vo['ischeck']" value="1"> class="activity2_main2_y_list"</eq>>
                                    <i>{$vo.title}</i>
                                </li>
                            </volist>
                        </ul>
            ...
            <div class="activity2_main2_01">
                ...
                <div class="middle activity2_main2_text2">
                    <input type="text" name="fee" value="{$data.fee}" required/>
                    <i>元/人</i>
                </div>
                ...
                <div class="middle activity2_main2_text3">
                    <select class="sc-wd chosen-select-no-single" name="man">
                        ...
                        <volist name="noteman" id="vo">
                          <option value="{$vo.id}" <if condition="$data['man'] eq $vo['id']">selected</if>>{$vo.catname}</option>
                        </volist>
                    </select>
                </div>
            ...
            <div class="travels3_main">
                ...
                <div class="travels3_main2">
                    ...
                    <notempty name="imglist">
                        <volist name="imglist" id="vo">
                            <div class="hidden travels3_main2_a"  id="content_{$key}">
                                <div class="fl travels3_main2_b">
                                    <span class="upload" id="uploadbtn_{$key}" data-id="imglist_{$key}" data-thumbid="img_{$key}"></span>
                                </div>
                                <div class="fl travels3_main2_b img" id="img_{$key}"><img src="{$vo.thumb}" style="width:202px;height:152px" /></div>
                                <div class="fl travels3_main2_c" style="width:775px">
                                    <input type="hidden" class="thumb" id="imglist_{$key}" name="imglist[{$key}][thumb]" value="{$vo.thumb}">
                                    <textarea placeholder="描述 ：" name="imglist[{$key}][content]" >{$vo.content}</textarea>
                                </div>
                            </div>
                        </volist>
                    </notempty>
                ...
                <div class="travels3_main_tab">
                    ...
                    <input class="sub" type="submit" value="修改游记" />
