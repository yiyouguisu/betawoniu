...
<include file="public:mheader" />
    <div style="background:#f4f4f4;">
        ...
        <div class="wrap">
            <form action="{:U('Home/Order/editorder_party')}" method="post" onsubmit="return checkform();">
                <script>
                    function checkform(){
                ...
                <div class="Fill_in_order2_main1">
                    ...
                    <div class="Fill_in_order2_div_public Fill_in_order2_main5">
                        ...
                        <div class="payment_main4 hidden">
                            <div class="fl payment_main4_1">
                                <span>￥<em id="money">{$data.productinfo.money|default="0.00"}</em></span>
                                <i>（活动费用 x <i id="mannum">{$data.productinfo.num|default="0"}</i>人）</i>
                                <label>—</label>
                    ...
                    <div class="payment_main6 hidden">
                        ...
                        <input type="hidden" name="num" value="{$data.num|default='0.00'}">
                        <input type="hidden" name="memberids" value="">
                        <input type="hidden" name="aid" value="{$data['productinfo']['aid']}">
