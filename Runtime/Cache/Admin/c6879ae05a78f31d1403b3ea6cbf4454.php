...
<head>
    ...
    <link href="/Public/Admin/css/admin_layout.css?v=" rel="stylesheet" />
    <link href="/Public/Admin/js/artDialog/skins/default.css" rel="stylesheet" />
    <script src="/Public/Admin/js/jquery.js"></script>
    <script src="/Public/Admin/js/layer/layer.js"></script>
    <link rel="stylesheet" href="/Public/Admin/js/layer/skin/layer.css" id="layui_layer_skinlayercss">
    <style>
...
<body>
    <div class="wrap">
        ...
        <table width="100%" height="100%" style="table-layout: fixed;">
            <tr class="head">
                <th>
                    <a href="<?php echo U('Admin/Index/index');?>" class="logo">管理中心</a></th>
                <td>
                    <div class="nav">
                    ...
                    <div class="login_info">
                        <a id="nowTime"></a><span class="mr10"><?php echo ($User["role_name"]); ?>： <?php echo ($User["username"]); ?></span>
                        <a href="<?php echo U('Admin/Public/loginout');?>" class="mr10">[注销]</a>
                        <!-- <a href="<?php echo U('Home/Index/index');?>" class="home" target="_blank">前台首页</a> -->
                        <!--                            <a href="<?php echo U('Admin/Member/index');?>" class="home" target="_blank">会员中心</a>-->
                        <a href="javascript:;" onclick="omnipotent('selectid','<?php echo U('Admin/Index/public_cache');?>','清除缓存',1,700,420)" class="home" style="color: #fff">缓存更新</a>
                    </div>
                </td>
            </tr>
            <tr class="tab">
                <th>
                    <div class="search">
                        ...
                        <button type="button" name="keyword" id="J_search" value="" data-url="<?php echo U('Admin/index/public_find');?>">菜单搜索</button>
                    </div>
                </th>
                <td>
            ...
            <tr class="content">
                ...
                <td id="B_frame" style="height: 100%;">
                    ...
                    <iframe id="iframe_default" src="<?php echo U('Admin/Index/main');?>" style="height: 100%; width: 100%; display: none;" data-id="default" frameborder="0" scrolling="auto"></iframe>
                </td>
            </tr>
        </table>
    </div>
