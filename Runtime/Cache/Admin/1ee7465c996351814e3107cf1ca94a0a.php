...
<?php } ?>
        ...
        <form action="<?php echo U('Admin/Roomcate/listorder');?>" method="post">
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="45%" align="left">设施名称</td>
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center" > 
                              <a href="<?php echo U('Admin/Roomcate/edit',array('id'=>$vo['id']));?>" >修改</a> 
                              <a href="<?php echo U('Admin/Roomcate/delete',array('id'=>$vo['id']));?>"  class="del">删除</a>  
                            </td>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <?php if(authcheck('Admin/Roomcate/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?>
