...
<include file="Common:Head" /><body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Order/waitdistribute')}">
        ...
        <form action="{:U('Admin/Order/deals')}" method="get" >
            <div class="table_list">
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="9%" align="center" >下单用户</td>
                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            <td><input type="checkbox" class="J_check" data-yid="J_check_y" data-xid="J_check_x" name="ids[]" value="{$vo.orderid}"></td>
                            ...
                            <td align="center" > 
                                <if condition="$vo['status'] neq 5">
                                    <empty name="vo['puid']">
                                            <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Order/deal',array('orderid'=>$vo['orderid']))}','派发订单',1,300,180)">派发</a></br>
                                        <else />
                                        已派发</br>
                                    </empty>
                                    <else />
                ...
                <div class="p10">
                    ...
                    <button class="btn btn_submit mr10 " type="submit" name="deals" value="deals">批量派发</button>
                    </form>
                </div>
            </div>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <form method="post" action="{:U('Admin/Orderexcel/excel')}">
                            ...
                            <input type="hidden"  name="iswaitdistribute" value="1" >
