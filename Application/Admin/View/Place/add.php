...
<include file="Common:Nav"/>
  ...
  <form name="myform" id="myform" action="{:U('Admin/Place/add')}" method="post" enctype="multipart/form-data">
    ...
    <div class="J_tabs_contents">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            <tr id="normal_add">
              <th width="200">名称：</th>
              <td><input type="text" name="title" id="title" class="input" value=""></td>
            </tr>
            <tr>
              <th>显示排序：</th>
