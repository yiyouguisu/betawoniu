                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="8%" align="center" >订单来源</td>
                            ...
                            <!-- <td width="6%"  align="center" >包装状态</td>
                            ...
                            <td width="18%" align="center" >管理操作</td>
                        </tr>
                    </thead>
                    <tbody>
                 <?php $money_total1=0;?>
                        ...
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" > 
                                <if condition="$vo['status'] neq 5">
                                    ...
                                    <empty name="vo['ruid']">
                                        <a href="{:U('Admin/Order/dodistribute',array('orderid'=>$vo['orderid']))}">提示送货员</a></br>
                                        <else />
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <form method="post" action="{:U('Admin/Orderexcel/excel')}">
                            ...
                            <input type="hidden"  name="isspeed" value="1" >
