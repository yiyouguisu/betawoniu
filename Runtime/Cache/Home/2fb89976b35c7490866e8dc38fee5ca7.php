                                ...
                                <ul class="Top_contacts_m2_tab_ul">
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                            <div class="middle Top_contacts_m2_tab_list">
                                                <span class="realname"><?php echo ($vo["realname"]); ?></span>
                                            </div>
                                            <div class="middle Top_contacts_m2_tab_list2">
                                                <span class="idcard"><?php echo ($vo["idcard"]); ?></span>
                                            </div>
                                            ...
                                            <div class="Top_contacts_m2_tab_list4 middle">
                                                <i class="edit" data-id="<?php echo ($vo["id"]); ?>">编辑</i>
                                                <span class="delete" data-id="<?php echo ($vo["id"]); ?>">删除</span>
                                            </div>
...
<script>
    $(function(){
        $("#add").click(function(){
            ...
            if(lmid==''){
                var url="<?php echo U('Home/Member/ajax_add_linkman');?>";
            }else{
                var url="<?php echo U('Home/Member/ajax_edit_linkman');?>";
            }
            $.ajax({
                     type: "POST",
                     url: url,
        ...
        $(".delete").click(function(){
            ...
            if(confirm("确定删除吗？")){
                $.ajax({
                     type: "POST",
                     url: "<?php echo U('Home/Member/ajax_del_linkman');?>",
                     data: {'lmid':lmid},
                     dataType: "json",
                     success: function(data){
                        alert(data.msg)
