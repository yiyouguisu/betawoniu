...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        <div class="common-form">
            <form class="J_ajaxForm" method="post"  action="{:U('Admin/Tag/tagimport')}">
                <div class="h_a">导入</div>
                ...
                <div class="btn_wrap" style="position: fixed;bottom: 0;left: 7px;width: 100%;z-index: 5;">
                    <div class="btn_wrap_pd">
                        <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit">导入数据</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript">
        $(function(){
            $("#uploadify").uploadify({
                ...
                'script'  : "{:U('Admin/Tag/upload')}",//实现上传的程序
                'method'    : 'get',
