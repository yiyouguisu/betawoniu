...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form action="{:U('Admin/Roomcate/listorder')}" method="post">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center" > 
                              ...
                              <a href="{:U('Admin/Roomcate/delete',array('id'=>$vo['id']))}"  class="del">删除</a>  
                            </td>
                        </tr>
                    </volist>
                    </tbody>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <if condition="authcheck('Admin/Roomcate/listorder')">
