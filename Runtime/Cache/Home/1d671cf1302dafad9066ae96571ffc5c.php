        ...
        <li <?php if(($current_url) == "Home/Member/help"): ?>class="pd_main2_li pd_b6" <?php else: ?>class="pd_b6"<?php endif; ?>>
            ...
            <div class="fl pd_main3">
                ...
                <div class="pd_main13_botttom">
                    <div>
                        <span>密码 :</span>
                        <a href="<?php echo U('Home/Member/change_password');?>">修改密码</a>
                    </div>
                    <div>
                        <span>绑定手机 :</span>
                        <i><?php echo ((isset($user["phone"]) && ($user["phone"] !== ""))?($user["phone"]):"未绑定"); ?></i>
                        <?php if(!empty($user['phone'])): ?><label><img src="/Public/Home/images/Icon/img68.png" />已绑定</label>
                            <a href="">更改号码</a><?php endif; ?>
                    </div>
                </div>
                <div class="pd_main14_bottom">
                    ...
                    <div>
                        <span>验证方式 :</span><input class="pd_main14_btn2" type="text" placeholder="验证<?php echo substrreplace($user['phone']);?>" />
