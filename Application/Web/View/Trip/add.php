                    ...
                    <div class="trip_dragBtm">
                        <div class="trip_d ">
                            ...
                            <div class="trip_hBox" id="add_trip_box_all" data-seq="0">
                              <notempty name="hotels">
                                <volist name="hotels" id="hotel">
                                   <div class="trip_h trip_drag f0 trip_point">
                                     <input type="hidden" class="activity_value trip_value" data-type="activity" data-varname="hostel" data-city="{$hotel['city']}" data-cityname="{$hotel['cityname']}" data-id="{$hotel['contentid']}" data-event="{$hotel['title']}">
                                     <div class="trip_h1 vertical">{$hotel['place']}</div>
                                     <div class="trip_h2 vertical">{$hotel['event']}</div>
