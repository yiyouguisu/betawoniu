...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Question/index');?>">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            <option value='0' <?php if( $searchtype == '0' ): ?>selected<?php endif; ?>>题目</option>
        ...
        <form action="<?php echo U('Admin/Question/action');?>" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="15%" align="center" >题目</td>
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td align="center" >
                                ...
                                <?php if($vo["type"] == 1): ?><span style="color: red">[推]</span><?php endif; ?>
                                <?php if($vo["islink"] == 1): ?><span style="color: red">[外链]</span><?php endif; ?>
                            ...
                            <td align="center" > 
                                <?php if(authcheck('Admin/Question/edit')): ?><a href="<?php echo U('Admin/Question/edit',array('id'=>$vo['id']));?>" >修改</a> 
                <?php else: ?>
                 <font color="#cccccc">修改</font><?php endif; ?> 
                            <?php if(authcheck('Admin/Question/delete')): ?><a href="<?php echo U('Admin/Question/delete',array('id'=>$vo['id']));?>"  class="del">删除</a> 
                <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                     <?php if(authcheck('Admin/Question/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder" >排序</button><?php endif; ?> 
                   <?php if(authcheck('Admin/Question/review')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="review">审核</button><?php endif; ?>
                 <?php if(authcheck('Admin/Question/unreview')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unreview">取消审核</button><?php endif; ?>
                        <?php if(authcheck('Admin/Question/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
