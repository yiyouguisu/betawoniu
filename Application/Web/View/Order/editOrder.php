...
<body class="back-f1f1f1">
  ...
  <div class="container padding_0" style="margin-top:6rem">
      ...
      <form action="{:U('Web/Order/createbook')}" method="post" id='form' onsubmit="return checkForm();">
          <input type="hidden" name="orderid" value="{$bookroom.orderid}">
          <div class="yr">
              ...
              <div class="yr-b" style="margin-bottom:0;">
                  <div class="yr-c center fl time-box" data-target="#start_time" data-type="start">
                      ...
                      <div class="yr-c3">
                          <input class="ggo_text begin" name="starttime" type="date" value="{$startTime|date='Y-m-d', ###}"
                          id="start_time" style="display:none;">
                          <span>{$startTime|date='Y-m-d', ###}</span>
                      </div>
                  </div>
                  ...
                  <div class="yr-c center fl time-box" data-target="#leave_time" data-type="end">
                      ...
                      <div class="yr-c3">
                          <input class="ggo_text end" name="endtime" type="date" value="{$endTime|date='Y-m-d', ###}"
                          id="leave_time" style="display:none;">
                          <span>{$endTime|date='Y-m-d', ###}</span>
                      </div>
                  </div>
              </div>
          ...
          <div class="we_a" style="margin-bottom:8rem;">
              ...
              <div class="yr_list">
                  ...
                  <div class="we_c">
                      ...
                      <div class="olist">
                          <a id="add_people" style="vertical-align:middle;margin:0" class="ft14" href="{:U('Web/Member/topContacts')}?orderid={$bookroom.orderid}&days={$days}&starttime={$startTime|date='Y-m-d',###}&endtime={$endTime|date='Y-m-d',###}&rooms={$roomNum}">+添加</a>
                      </div>
                  </div>
              </div>
      ...
      <!--
              ...
              <div class="help_list" style="border-radius:5px;">
                  <div class="help_a ft12">选择优惠券</div>
              </div>
-->
          </div>
...
<div class="pyl">
  ...
  <script type="text/javascript">
      ...
      function total()
      {
        ...
        var rooms = $('#rooms').val();
        allmoney = (allmoney * rooms).toFixed(2);
        $("#total").text(allmoney);
