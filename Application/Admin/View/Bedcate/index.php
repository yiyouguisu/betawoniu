...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form action="{:U('Admin/Bedcate/listorder')}" method="post">
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="45%" align="left">床型名称</td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center" > 
                              <a href="{:U('Admin/Bedcate/edit',array('id'=>$vo['id']))}" >修改</a> 
                              <a href="{:U('Admin/Bedcate/delete',array('id'=>$vo['id']))}"  class="del">删除</a>  
                            </td>
                        </tr>
                    </volist>
                    </tbody>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <if condition="authcheck('Admin/Bedcate/listorder')">
