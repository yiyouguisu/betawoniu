...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <form method="post" action="{:U('Admin/Inn/edit')}">
                ...
                <div class="table_full">
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th width="80">一等奖剩余数量:</th>
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="leftprize1" class="input length_6 input_hd" placeholder="请输入一等奖数量" id="leftprize1" value="{$data.leftprize1}" disabled="true">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">二等奖剩余数量:</th>
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="leftprize2" class="input length_6 input_hd" placeholder="请输入二等奖数量数量" id="leftprize2" value="{$data.leftprize2}" disabled="true">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">三等奖剩余数量:</th>
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="leftprize3" class="input length_6 input_hd" placeholder="请输入三等奖数量" id="leftprize3" value="{$data.leftprize3}" disabled="true">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">四等奖剩余数量:</th>
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="leftprize4" class="input length_6 input_hd" placeholder="请输入三等奖数量" id="leftprize4" value="{$data.leftprize4}" disabled="true">
                                </td>
                            </tr>
                            <tr>
                                <th width="80">五等奖剩余数量:</th>
                                <td>
                                    <span class="must_red">*</span>
                                    <input type="text" name="leftprize5" class="input length_6 input_hd" placeholder="请输入三等奖数量" id="leftprize5" value="{$data.leftprize5}" disabled="true">
                                </td>
                            </tr>
