...
<script>
    $(function(){
        ...
        var province='<?php echo ($data["province"]); ?>';
        var city='<?php echo ($data["city"]); ?>';
        if(province!=''){
          load(province,'city');
        }
        if(city!=''){
                ...
                if (type == 'city') {
                    ...
                    if(data!=null){
                        $.each(data, function (no, items) {
                            if (items.id == "<?php echo ($data['city']); ?>") {
                    ...
                    if(data!=null){
                        $.each(data, function (no, items) {
                            if (items.id == "<?php echo ($data['town']); ?>") {
...
<div class="wrap">
       <div class="activity_main">
           ...
           <a href="<?php echo U('Home/Party/index');?>">活动</a>
           <span>></span>
           <a href="<?php echo U('Home/Party/edit',array('id'=>$data['id']));?>">修改活动</a>
       </div>
    ...
    <div class="wrap">
        <form action="<?php echo U('Home/Party/edit');?>" method="post">
            <div class="activity2_main2">
                <div class="activity2_main2_01">
                    <span class="middle">活动标题 : </span>
                    <input class="middle text4" style="width:670px;" type="text" name="title" value="<?php echo ($data["title"]); ?>" required/>
                </div>
                <div class="activity2_main2_01">
                    ...
                    <div class="activity2_main2_select middle">
                        <select name="hid">
                            ...
                            <?php if(is_array($hostel)): $i = 0; $__LIST__ = $hostel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['hid'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        <select>
                    </div>
                </div>
                <div class="activity2_main2_01">
                    ...
                    <div class="activity2_main2_text1 middle">
                        <i>开始时间 :</i>
                        <input id="d5221" class="J_date starttime" type="text" name="starttime" value="<?php echo ($data["starttime"]); ?>" required/>
                    </div>
                    <i><input type="text" id="days" value="<?php echo ($data["days"]); ?>" style="    width: 20px;border: none;color: #21a7bb;">天</i>
                    <div class="activity2_main2_text1 middle">
                        <i>结束时间 :</i>
                        <input id="d5222" class="J_date endtime" type="text" name="endtime" value="<?php echo ($data["endtime"]); ?>" required/>
                    </div>
                    ...
                    <div class="middle activity_main2_text2 hidden">
                        <div class="activity_main2_text3 middle">
                            <input type="text" value="<?php echo ($data["start_numlimit"]); ?>" class="middle" name="start_numlimit"/>
                            <span class="middle">人</span>
                        </div>
                        <i class="middle">至</i>
                        <div class="activity_main2_text3 middle">
                            <input type="text" class="middle" value="<?php echo ($data["end_numlimit"]); ?>" name="end_numlimit"/>
                            <span class="middle">人</span>
                        </div>
                    </div>
                </div>
                <div class="activity2_main2_01">
                    ...
                    <div class="middle activity2_main2_text2">
                        <input type="text" value="<?php echo ($data["money"]); ?>" name="money"required/>
                        <i>元/人</i>
                    </div>
                    <div <?php if(($data['isfree']) == "1"): ?>class="middle activity2_a activity2_b"<?php else: ?> class="middle activity2_a"<?php endif; ?>>免费活动</div>
                    ...
                    <div class="middle activity2_main2_text3">
                        <select class="sc-wd chosen-select-no-single" name="catid" required>
                            ...
                            <?php if(is_array($partycate)): $i = 0; $__LIST__ = $partycate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['catid'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["catname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="middle activity2_main2_text3">
                        <select class="sc-wd chosen-select-no-single" name="partytype" required>
                            ...
                            <option value="1" <?php if($data['partytype'] == 1): ?>selected<?php endif; ?>>亲子类</option>
                            <option value="2" <?php if($data['partytype'] == 2): ?>selected<?php endif; ?>>情侣类</option>
                            <option value="3" <?php if($data['partytype'] == 3): ?>selected<?php endif; ?>>家庭出游</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="activity2_main2_01">
                    ...
                    <div class="middle activity2_main2_text3" style="width: 45%;">
                        <select class="middle activity2_main2_text3 sc-wd chosen-select-no-single" required name="province" id="province" onchange="load(this.value,'city')">
                            ...
                            <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($data['province'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    ...
                    <input type="text" name="address" value="<?php echo ($data["address"]); ?>" class="activity2_main2_text5 middle" style="width:430px"/>
                </div>
                ...
                <div class="Release_of_legend_x"  style="margin-top: 20px;">
                    ...
                    <div class="middle Release_of_legend_y">
                        <span>活动报名满</span>
                        <div>
                            <input type="text" name="vouchersrange" value="<?php echo ($data["vouchersrange"]); ?>" required />
                            <i>元</i>
                        </div>
                        <span>金额送</span>
                        <div>
                            <input type="text" name="vouchersdiscount" value="<?php echo ($data["vouchersdiscount"]); ?>" required/>
                            <i>元</i>
                        </div>
                        <span>金额的抵用券</span>
                    </div>
                ...
                <div class="Release_of_legend_main2">
                    <span>活动摘要  : </span>
                    <textarea style="width: 100%; height: 200px;" name="description" ><?php echo ($data["description"]); ?></textarea>
                </div>
                <div class="Release_of_legend_main2">
                    <span>取消报名规则  : </span>
                    <textarea style="height: 100px;" name="cancelrule"  id="cancelrule" ><?php echo ($data["cancelrule"]); ?></textarea>
                </div>
                <div class="activity3">
                    ...
                    <div class="activity3_tab">
                        ...
                        <input type="hidden" name="isfree" value="<?php echo ($data["isfree"]); ?>" />
