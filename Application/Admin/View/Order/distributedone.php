...
<include file="Common:Head" /><body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Order/distributedone')}">
                 ...
                 <?php $money_total1=0;?>
                    <volist name="data" id="vo">
                        <tr class="productshow" data-id="{$vo.id}">
                            ...
                            <td align="center" > 
                                已派发给{:getAuser($vo['puid'])}包装</br>
                                <a href="{:U('Admin/Order/cancel',array('orderid'=>$vo['orderid']))}" class="cancel">取消订单</a></br>
                                <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Order/orderprint',array('orderid'=>$vo['orderid']))}','打印订单',1,390,250)">打印</a></br>
                                <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Order/dealagain',array('orderid'=>$vo['orderid']))}','重新派发订单',1,300,180)">重新派发</a></br>
                            </td>
                        </tr>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <form method="post" action="{:U('Admin/Orderexcel/excel')}">
                            ...
                            <input type="hidden"  name="isdistributedone" value="1" >
