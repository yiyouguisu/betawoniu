...
<script src="/Public/Home/js/chosen.jquery.js"></script>
    ...
    <script src="/Public/Home/js/work.js"></script>
    <script src="/Public/Home/js/jquery-browser.js"></script>
...
<div class="travels2">
        <div class="travels2_top" style="background: url('<?php echo ((isset($data["background"]) && ($data["background"] !== ""))?($data["background"]):'/Public/Home/images/img51.jpg'); ?>') no-repeat center center;background-size: 100% 200px;height: 200px;">
                ...
                <div class="travels2_bottom2">
                    <div class="travels2_bottom2_01">
                        <div class="travels2_bottom2_02 middle">
                            <span class="f16 c000"><?php echo ($data["nickname"]); ?></span>
                        </div>
                        <div class="middle travels2_bottom2_03 hidden">
                            <div class="travels2_bottom2_04 fl tr">
                                <img src="/Public/Home/images/Icon/img10.png" />
                                <span class="f15 c999"><em class="c999 f16"><?php echo ((isset($data["reviewnum"]) && ($data["reviewnum"] !== ""))?($data["reviewnum"]):"0"); ?></em>条评论</span>
                            </div>
                            <div class="travels2_bottom2_05 fl tr">
                                ...
                                <span class="c999 f15 zannum"><?php echo ((isset($data["hit"]) && ($data["hit"] !== ""))?($data["hit"]):"0"); ?></span>
                            </div>
                            <div class="travels2_bottom2_04 fl tr">
                                <span class="f12 c999"><?php echo (date("Y-m-d H:i",$data["inputtime"])); ?> </span>
                            </div>
                            <div class="travels2_bottom2_05 fl tr">
                                <span class="f12 c999"> 浏览：<em class="f12 c999"></em><?php echo ((isset($data["view"]) && ($data["view"] !== ""))?($data["view"]):"0"); ?></span>
                            </div>
                        </div>
                        <div class="middle travels2_bottom2_06 tr">
                            <a href="">
                                <img src="/Public/Home/images/Icon/img24.png" />
                            </a>
                            <a href="javascript:;">
        ...
        <div class="Event_details5 hidden">
            <div class="fl Event_details5_1"> 
                <div class="Event_details5_1_01 hidden">
                    <div class="Event_details5_1_02_01">
                        <img src="/Public/Home/images/Icon/img86.png" />
                        <span>出发时间 :</span>
                        <i><?php echo (date("Y-m-d",$data["begintime"])); ?> 至<?php echo (date("Y-m-d",$data["endtime"])); ?></i>
                    </div>
                    <div class="Event_details5_1_02_01">
                        <img src="/Public/Home/images/Icon/img87.png" />
                        <span>人均费用 : </span>
                        <i>￥<?php echo ((isset($data["fee"]) && ($data["fee"] !== ""))?($data["fee"]):"0.00"); ?></i>
                    </div>
                    <div class="Event_details5_1_02_04">
                        <img src="/Public/Home/images/Icon/img88.png" />
                        <span>形式 : </span>
                        <i><?php echo ($data["notestyle"]); ?></i>
                    </div>
                    <div class="Event_details5_1_02_01">
                        <img src="/Public/Home/images/Icon/img89.png" />
                        <span>人物 : </span>
                        <i><?php echo ($data["noteman"]); ?> </i>
                    </div>
                    <div class="Event_details5_1_02_01">
                        <img src="/Public/Home/images/Icon/img90.png" />
                        <span>出行天数 :</span>
                        <i><?php echo ((isset($data["days"]) && ($data["days"] !== ""))?($data["days"]):"0"); ?>天</i>
                    </div>
                </div>
                ...
                <div class="Event_details5_3">
                    ...
                    <?php if(is_array($data['content'])): $i = 0; $__LIST__ = $data['content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p><?php echo ($vo["content"]); ?></p>
                        <?php if(!empty($vo['thumb'])): ?><img class="pic" data-original="<?php echo ($vo["thumb"]); ?>" src="/Public/Home/images/default.jpg" /><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="Event_details6">
                    ...
                    <div class="Event_details6_02">
                        ...
                        <!-- <div class="Event_details6_04 pr">
                            ...
                            <img class="emotion" src="/Public/Home/images/Icon/img31.png" />
                        </div> -->
                    </div>
                ...
                $(function(){
                    ...
                    var geturl = "<?php echo U('Home/Note/get_review');?>";
                    ...
                    $("#addreview").click(function(){
                        ...
                        if(uid==''){
                            alert("请先登录！");
                            var loginp={};
                            loginp['url']="/index.php/Home/Note/show/id/41.html";
                        ...
                        if(rid!=''){
                            if(type=='reply'){
                                $.post("<?php echo U('Home/Note/add_reviewreply');?>",{"nid":nid,"rid":rid,"content":content,"uid":uid},function(d){
                                    d=eval("("+d+")");
                                    if(d.code==200){
                                        $.get(geturl,p,function(d){
                                            $(".reviewlist").html(d.html);
                                ...
                                $.post("<?php echo U('Home/Note/add_reviewquote');?>",{"nid":nid,"rid":rid,"content":content,"uid":uid},function(d){
                                    d=eval("("+d+")");
                                    if(d.code==200){
                                        $.get(geturl,p,function(d){
                                            $(".reviewlist").html(d.html);
                            ...
                            $.post("<?php echo U('Home/Note/add_review');?>",{"nid":nid,"content":content,"uid":uid},function(d){
                                d=eval("("+d+")");
                                if(d.code==200){
                                    $.get(geturl,p,function(d){
                                        $(".reviewlist").html(d.html);
            ...
            <div class="fl travels2_main">
                <div class="travels2_main2">
                    ...
                    <?php if(is_array($data['note_hostel'])): $i = 0; $__LIST__ = $data['note_hostel'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><i data-hid="<?php echo ($vo["hid"]); ?>" data-uid="<?php echo ($vo["uid"]); ?>"><em>+</em><?php echo ($vo["title"]); ?></i><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="travels2_main3 hidden">
                    ...
                    <ul class="travels2_main3_ul hidden">
                        <?php if(is_array($data['note_place'])): $i = 0; $__LIST__ = $data['note_place'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <i data-hid="<?php echo ($vo["hid"]); ?>" data-uid="<?php echo ($vo["uid"]); ?>">
                                    <em>+</em><?php echo ($vo["title"]); ?>
                                </i>
                ...
                <div class="travels2_main4">
                    ...
                    <ul class="travels2_main4_ul">
                        <?php if(is_array($data['relative_note'])): $i = 0; $__LIST__ = $data['relative_note'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="hidden">
                                <?php if($key <= 2): ?><div class="fl travels2_main4_02">
                                        <?php if(($key) == "0"): ?><img src="/Public/Home/images/Icon/img34.png" /><?php endif; ?>
                                        <?php if(($key) == "1"): ?><img src="/Public/Home/images/Icon/img35.png" /><?php endif; ?>
                                        <?php if(($key) == "2"): ?><img src="/Public/Home/images/Icon/img36.png" /><?php endif; ?>
                                    </div><?php endif; ?>
                                <div class="fl travels2_main4_03">
                                    <span class="c333 f18"><?php echo str_cut($vo['title'],10);?></span>
                                    <i class="f12"><?php echo (date("Y-m-d",$vo["inputtime"])); ?></i>
                                </div>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
        ...
        $(function () {
            $(".travels2_main2 i").click(function(){
                ...
                if(uid==''){
                    alert("请先登录！");
                    var p={};
                    p['url']="/index.php/Home/Note/show/id/41.html";
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#reportsave").live("click",function(){
                ...
                $.post("<?php echo U('Home/Note/add_report');?>",{"rid":rid,"content":reportreason,"uid":uid},function(d){
                    d=eval("("+d+")");
                    if(d.code==200){
                        alert(d.msg)
                        $(".My_message_details_main2").hide();
    ...
    <div class="wrap">
        <div class="Event_details7">
            ...
            <div class="Event_details8 hidden">
                <ul class="Event_details8_ul clearfix">
                    <?php if(is_array($data['note_near_hostel'])): $i = 0; $__LIST__ = $data['note_near_hostel'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl">
        ...
        <div class="Event_details7">
            ...
            <div class="Event_details8 hidden">
                <ul class="Event_details8_ul clearfix">
                    <?php if(is_array($data['note_near_activity'])): $i = 0; $__LIST__ = $data['note_near_activity'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl">
                            <div class="Event_details8_li">
                                <div class="Event_details8_list">
...
<script type="text/javascript">
    $(function () {
        ...
        $(".shoucang").live("click",function(){
            ...
            $.ajax({
                 type: "POST",
                 url: "<?php echo U('Home/Note/ajax_collect');?>",
                 data: {'nid':nid},
                 dataType: "json",
                 success: function(data){
                            if(data.status==1){
