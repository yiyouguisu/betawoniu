...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Party/index')}">
        ...
        <form action="{:U('Admin/Party/action')}" method="post" >
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" > 
                                ...
                                <if condition="authcheck('Admin/Order/party')">
                                    <a href="{:U('Admin/Order/party',array('aid'=>$vo['id']))}" >报名详情</a> 
                                    <else/>
                                    <font color="#cccccc">报名详情</font>
                                </if> 
                                <eq name="vo['status']" value="1">
                                    <if condition="authcheck('Admin/Party/review')">
                                      <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Party/review',array('id'=>$vo['id']))}','审核',1,700,300)">审核</a>
                                      <else/>
                                ...
                                <if condition="authcheck('Admin/Party/delete')">
                                    <a href="{:U('Admin/Party/delete',array('id'=>$vo['id']))}"  class="del">删除</a> 
                                    <else/>
