                ...
                <div class="Snail_home_mr_01 hidden">
                                ...
                                <div class="pr Snail_home_mr_01_list">
                                    ...
                                    <div class="Snail_home_mr_01_list2">
                                        <a href="<?php echo U('Home/Member/detail',array('uid'=>$vo['uid']));?>">
                                            ...
                                            <img src="/Public/Home/images/Icon/img27.png" /> 
                                        </a>
                                    </div>
                                    <div class="Snail_home_mr_01_list3 hidden">
                                        <div class="fl Snail_home_mr_01_list3_01">
                                            <span><?php echo ((isset($vo["attentionnum"]) && ($vo["attentionnum"] !== ""))?($vo["attentionnum"]):"0"); ?></span>
                                            <i>关注</i>
                                        </div>
                                        <div class="fl Snail_home_mr_01_list3_01">
                                            <span><?php echo ((isset($vo["fansnnum"]) && ($vo["fansnnum"] !== ""))?($vo["fansnnum"]):"0"); ?></span>
                                            <i>粉丝</i>
                                        </div>
                                    </div>
                                    <div class="Snail_home_mr_01_list4 hidden">
                                        <span>已关注</span>
                                        <a href="<?php echo U('Home/Woniu/chatdetail',array('tuid'=>$vo['uid']));?>">发私信</a>
                                    </div>
                                </div>
                    ...
                    <div class="Snail_home_a">
                        <div class="Snail_home_a1">
                            <span>共<?php echo ((isset($totalnum) && ($totalnum !== ""))?($totalnum):"0"); ?>位好友</span>
                        </div>
                    </div>
                    <div class="Snail_home_b">
                        <span onclick="window.location.href='<?php echo U('Home/Woniu/morefriend');?>'">添加更多好友</span>
                    </div>
                </div>
            </div>
        </div>
