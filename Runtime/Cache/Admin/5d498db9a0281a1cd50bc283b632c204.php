                    ...
                    <table width="100%" class="table_form contentWrap">
                        <tbody>
                            ...
                            <tr>
                                <th>活动时间</th>
                                <td>
                                    <input type="text" name="starttime" class="input length_2 J_date starttime" value="<?php echo ($data["begintime"]); ?>" style="width:120px;">
                                    -
                                    <input type="text" class="input length_2 J_date endtime" name="endtime" value="<?php echo ($data["endtime"]); ?>" style="width:120px;">
                                </td>
                            </tr>
                            <tr>
                                <th>人数限制</th>
