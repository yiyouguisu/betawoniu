...
<div class="header center z-index112 pr f18">
      ...
      <div class="tra_pr map_small f14 pa"><a href=""><img src="__IMG__/map_small.jpg">地图</a></div>      
</div>
                    ...
                    <div class="recom_list pr">
                        <a href="{:U('Web/Hostel/show',array('id'=>$vo['id']))}"><div class="recom_a pr"><img src="{$vo.thumb}">
                            ...
                            <div class="recom_g f18 center pa">
                                ...
                                <div class="recom_g2 fl">8.8<span>分</span></div>
                            </div>
                        </div></a>
   ...
   $(function(){
    ...
    function addHtml(data){
        ...
        $.each(data,function(i,value){
            ...
            content+='<div class="recom_d pa"><img src="'+value.head+'"></div><div class="recom_g f18 center pa">';
            content+='<div class="recom_g1 fl"><em>￥</em>'+value.money+'<span>起</span></div><div class="recom_g2 fl">8.8<span>分</span></div>';
