...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        ...
        <div class="common-form">
            <!---->
            <form method="post"  action="{:U('Admin/Vouchers/edit')}">
                            ...
                            <tr>
                                ...
                                <td>
                                  <ul class="switch_list cc ">
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherstype' value='all' <eq name="data['voucherstype']" value="all">checked</eq>>
                                          <span>全部</span></label>
                                      </li>
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherstype' value='hostel' <eq name="data['voucherstype']" value="hostel">checked</eq> >
                                          <span>美宿</span></label>
                                      </li>
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherstype' value='party' <eq name="data['voucherstype']" value="party">checked</eq>>
                                          <span>活动</span></label>
                                      </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                  <ul class="switch_list cc ">
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherscale' value='all'  <eq name="data['voucherscale']" value="all">checked</eq>>
                                          <span>全部</span></label>
                                      </li>
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherscale' value='area' <eq name="data['voucherscale']" value="area">checked</eq>>
                                          <span>区域范围</span></label>
                                      </li>
                                      <li>
                                        <label>
                                          <input type='radio' name='voucherscale' value='assign' <eq name="data['voucherscale']" value="assign">checked</eq>>
                                          <span>特定</span></label>
                                      </li>
                                    </ul>
                                </td>
                                    ...
                                    <ul class="switch_list cc hostelmorelist">
                                        <volist name="hostel" id="vo">
                                            <li style="width: 260px;">
                                                <label>
                                                    <input type='checkbox' name='hid[]' value='{$vo.id}' <eq name="vo['ischeck']" value="1">checked</eq>><span>{:str_cut($vo['title'],10)}</span></label>
                                            </li>
                                        </volist>
                                    </ul>
                                ...
                                <td>
                                    <ul class="switch_list cc partymorelist">
                                        <volist name="party" id="vo">
                                            <li style="width: 260px;">
                                                <label>
                                                    <input type='checkbox' name='aid[]' value='{$vo.id}' <eq name="vo['ischeck']" value="1">checked</eq>><span>{:str_cut($vo['title'],10)}</span></label>
                                            </li>
                                        </volist>
                                    </ul>
                            ...
                            <script>
                                $(function () {
                                    ...
                                    $(".hostelmore").click(function () {
                                        $.get("{:U('Admin/Vouchers/ajax_getmorehostel')}",{"p":pp,"hid":hid},function(data){
                                                var ahtml="";
                                    ...
                                    $(".partymore").click(function () {
                                        $.get("{:U('Admin/Vouchers/ajax_getmoreparty')}",{"p":pp,"aid":aid},function(data){
                                                var ahtml="";
                                                $.each(data,function(index,item){
                                                    ahtml += "<li style=\"width: 260px;\">";
                                                    ahtml += "<label>";
                                                    if (item.ischeck == 1) {
                                                        ahtml += "<input type='checkbox' name='aid[]' value='" + item.id + "' checked><span>" + item.title + "</span></label>";
                                                    } else {
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var voucherscale="{$data.voucherscale}";
            var voucherstype="{$data.voucherstype}";
            if (voucherscale == "all") {
                $("#area").hide();
                $("#hostel").hide();
                $("#party").hide();
