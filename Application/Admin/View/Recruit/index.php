...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Recruit/index')}">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            <option value='0' <if condition=" $searchtype eq '0' "> selected</if>>职位</option>
        ...
        <form action="{:U('Admin/Recruit/action')}" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="10%" align="left" >职位</td>
                            <td width="45%" align="left" >所属美宿</td>
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="left" >{$vo.house}</td>
                            <td align="center" >{$vo.inputtime|date="Y-m-d H:i:s",###}</td>
                            <td align="center" >{$vo.username}</td>
                            <td align="center" > 
                                <if condition="authcheck('Admin/Recruit/edit')">
              <a href="{:U('Admin/Recruit/edit',array('id'=>$vo['id']))}" >修改</a> 
                <else/>
                 <font color="#cccccc">修改</font>
              </if> 
                            <if condition="authcheck('Admin/Recruit/delete')">
              <a href="{:U('Admin/Recruit/delete',array('id'=>$vo['id']))}"  class="del">删除</a> 
                <else/>
