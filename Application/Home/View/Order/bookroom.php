        	...
        	<form action="{:U('Home/Order/dobookroom')}" method="post" onsubmit="return checkform();">
	            ...
	            <div class="Fill_in_order2_main1">
	                ...
	                <div class="Fill_in_order2_div_public Fill_in_order2_main1_1">
	                    <div>
	                        <span>房源信息 ：</span>
	                        <a href="{:U('Home/Hostel/show',array('id'=>$data['hid']))}" style="font-size:14px;color:#21a7bb; border:0px; margin:0px;padding:0px;width:1000px;text-align:left;">{$data.hostel}</a>
	                    </div>
	                    <div>
	                        <span>房东名称 ：</span>
	                    ...
	                    <div>
	                        ...
	                        <div class="Fill_in_order2_main1_2 middle">
	                            <label>入住：</label>
	                            <input type="text" name="starttime" class="J_date starttime" value="{$starttime}" />
	                        </div>
	                        ...
	                        <div class="Fill_in_order2_main1_2 middle">
	                            <label>离店：</label>
	                            <input type="text" name="endtime" class="J_date endtime" value="{$endtime}" />
	                        </div>
	                    </div>
	                    <div>
	                        <span>入住人数 ：</span>
