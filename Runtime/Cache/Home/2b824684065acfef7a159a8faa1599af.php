...
<div class="wrap">
       <div class="activity_main">
           <a href="/">首页</a>
           <span>></span>
           <a href="<?php echo U('Home/Member/houseowner');?>">申请成为房东</a>
       </div>
   </div>

    <div class="wrap">
        <form action="<?php echo U('Home/Member/houseowner');?>" method="post" onsubmit="return checkform();">
            <script type="text/javascript">
                    function checkform() {
        ...
        <div class="activity2_main2">
            <div class="activity2_main2_01">
                ...
                <input class="middle text4" style="width:185px;" type="text" name="realname" value="<?php echo ($data["realname"]); ?>" readonly/>
            </div>
            <div class="activity2_main2_01">
                <span class="middle">支付宝账号 : </span>
                <input class="middle text4" style="width:185px;" type="text" name="alipayaccount" value="<?php echo ($data["alipayaccount"]); ?>" />
            </div>
            <div class="activity2_main2_01">
                <span class="middle">美宿名称 : </span>
                <input class="middle text4" style="width:670px;" type="text" name="housename"  value="<?php echo ($data["housename"]); ?>"/>
            </div>            
            <div class="activity2_main2_01">
                <span class="middle">美宿地址 : </span>
                <input type="text" class="activity2_main2_text5 middle" style="width:722px !important;"  name="address" value="<?php echo ($data["address"]); ?>"/>
            </div>
            <div class="landlord1 hidden">
                ...
                <ul class="landlord1_ul">
                    ...
                    <li id="thumb">
                        <?php if(!empty($data['thumb'])): ?><img src="<?php echo ($data['thumb']); ?>" width='298px' height='169px' /><?php endif; ?>
                    </li>
                </ul>
                <div class="landlord2"></div>
                <input type="hidden" name="thumb" value="<?php echo ($data['thumb']); ?>" />
                <input class="lan_sub" type="submit" value="<?php echo ($data['btnstatus']); ?>" <?php if(($data["btnstatus"] == '请等待后台审核')): ?>disabled<?php endif; ?>  />
            </div>
        </div>
    </div>
    <script>
    ...
    <script type="text/javascript">
        $(function () {
            $("#uploadify").uploadify({
                ...
                'buttonImg': '/Public/Public/uploadify/authupload.gif',//替换上传钮扣
