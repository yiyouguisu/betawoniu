...
<div class="wrap J_check_wrap">
        ...
        <form action="{:U('Admin/Vouchers/action')}" method="post" >
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="center" > 
                                <a href="{:U('Admin/Vouchers/edit',array('id'=>$vo['id']))}" >修改</a> |
                                <a href="{:U('Admin/Vouchers/delete',array('id'=>$vo['id']))}" class="del" >删除</a> |
                                <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Vouchers/send',array('catid'=>$vo['id']))}','发放优惠券',1,700,400)">发放</a> |
                                <a href="{:U('Admin/Vouchers/sendlog',array('id'=>$vo['id']))}"  >发放日志</a>
                           </td>
                        </tr>
                    </volist>
                    </tbody>
