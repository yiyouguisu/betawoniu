                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" class="input length_4 input_hd" placeholder="请选择发布者" id="username" value="{$data.username}" readonly required>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="switch_list cc ">
                                        <li>
                                            <label><input type='radio' name='partytype' value='1' <eq name="data['partytype']" value="1"> checked</eq>><span>亲子类</span></label>
                                        </li>
                                        <li>
                                            <label><input type='radio' name='partytype' value='2' <eq name="data['partytype']" value="2"> checked</eq>><span>情侣类</span></label>
                                        </li>
                                        <li>
                                            <label><input type='radio' name='partytype' value='3' <eq name="data['partytype']" value="3"> checked</eq>><span>家庭出游</span></label>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" name="isfree" value="1" <if condition="$data['isfree'] eq 1">checked</if>/>免费活动
                                </td>
                            </tr>
                            <tr>
