...
<div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/apply/houseowner')}">
            ...
            <div class="search_type cc mb10">
                <div class="mb10"> <span class="mr20">
                        ...
                        <select class="select_2" name="searchtype" style="width:70px;">
                            ...
                            <option value='1' <if condition=" $searchtype eq '1' "> selected</if>>美宿名称</option>
                            <option value='2' <if condition=" $searchtype eq '2' "> selected</if>>美宿地址</option>
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <volist name="data" id="vo">
                        <tr>
                            ...
                            <td align="left" >{:getuserinfo($vo['uid'])}</td>
                            <td align="center" >{$vo.realname}</td>
                            <td align="center" >{$vo.housename}</td>
                            <td align="center" >{$vo.address}</td>
                            <td align="center"><img src="{$vo.thumb}" ondblclick='image_priview(this.src);' width="80px" height="80px"></td>
                            <td align="center" >{:getreviewstatus($vo['status'])}</td>
                            <td align="center" >{$vo.inputtime|date="Y-m-d H:i:s",###}</td>
                            <td align="center" > 
                               
            <eq name="vo['status']" value="1">
                                <if condition="authcheck('Admin/apply/houseownerreview')">
              <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/apply/houseownerreview',array('id'=>$vo['id']))}','审核',1,700,400)">审核</a>
                <else/>
                 <font color="#cccccc">审核</font>
              </if> 
              </eq>
                            <if condition="authcheck('Admin/apply/houseownerdelete')">
              <a href="{:U('Admin/apply/houseownerdelete',array('id'=>$vo['id']))}"  class="del">删除</a> 
                <else/>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <label class="mr20"><input type="checkbox" class="J_check_all" data-direction="y" data-checklist="J_check_y">全选</label>   
                        ...
                        <if condition="authcheck('Admin/apply/houseownerdel')">
                              <button class="btn btn_submit mr10 " type="submit" name="submit" value="houseownerdel">删除</button>
                        </if>
