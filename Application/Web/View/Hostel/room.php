...
<div class="container padding_0">
   <div class="land">
               <div class="act_g pr">
                    ...
                    <div class="recom_c pa"><div class="recom_gg collect <if condition='$data.iscollect eq 1'>recom_c_cut</if>" data-id="{$data.rid}"></div>
               ...
               <div class="det_box">
                       ...
                       <div class="edg">
                           <div class="edg_a fl">
                                      <div class="edg_b">8.8<span>分</span></div>
                                      <div class="edg_c">
                       ...
                       <div class="wx_box">
                              <div class="wx_top">
                                   <div class="wx_list">
                                         <div class="wx_a">
                                               <div class="wx_b vertical"><img src="__IMG__/wx_a9.jpg"> 建筑面积 : </div>
                                               <div class="wx_c vertical">{$data.area}M2</div>
                                         </div>
                                         
                                         <div class="wx_a">
                                               <div class="wx_b vertical"><img src="__IMG__/wx_a10.jpg"> 可住：</div>
                                               <div class="wx_c vertical">{$data.mannum}人</div>
                                         </div>
                                   </div>
                                   <div class="wx_list">
                                         <div class="wx_a">
                                               <div class="wx_b vertical"><img src="__IMG__/wx_a11.jpg"></div>
                                               <div class="wx_c vertical">24小时热水</div>
                                         </div>
                                         
                                         <div class="wx_a">
                                               <div class="wx_b vertical"><img src="__IMG__/stay_b3.png"></div>
                                               <div class="wx_c vertical">洗衣服务</div>
                                         </div>
                                   </div>
                                   <volist name='data["support"]' id='vo'>
                                   		<div class="wx_list">
                                   			<volist name='vo' id='svo'>
												<div class="wx_a">
													<div class="wx_b vertical"><img src="{$svo.gray_thumb}"></div>
               ...
               <div class="vb_c ">
                    ...
                    <div class="vb_c2"><p>{$data.content}</p></div>
                    <div class="vb_c3 snake_click"><a href="javascript:;">查看完整民宿房间简介</a></div>
               </div>   
