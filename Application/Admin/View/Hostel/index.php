...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <form method="get" action="{:U('Admin/Hostel/index')}">
        ...
        <form action="{:U('Admin/Hostel/action')}" method="post">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <eq name="vo['status']" value="1">
                                        <if condition="authcheck('Admin/Hostel/review')">
                                          <a href="javascript:;" onClick="omnipotent('selectid','{:U('Admin/Hostel/review',array('id'=>$vo['id']))}','审核',1,700,300)">审核</a>
                                          <else/>
                                          <font color="#cccccc">审核</font>
                                        </if> 
                                    </eq>
                                    <if condition="authcheck('Admin/Room/index')">
                                        <a href="{:U('Admin/Room/index',array('hid'=>$vo['id']))}">管理房间</a>
                                        <else />
                                    ...
                                    <if condition="authcheck('Admin/Hostel/delete')">
                                        <a href="{:U('Admin/Hostel/delete',array('id'=>$vo['id']))}" class="del">删除</a>
                                        <else />
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <if condition="authcheck('Admin/Hostel/unpushs')">
                        <button class="btn btn_submit mr10 " type="submit" name="submit" value="unpushs">取消推荐</button>
                    </if>
                    <if condition="authcheck('Admin/Hostel/del')">
