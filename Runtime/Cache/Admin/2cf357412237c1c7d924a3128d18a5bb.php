...
<?php } ?>
        ...
        <form method="get" action="<?php echo U('Admin/Hostel/index');?>">
        ...
        <form action="<?php echo U('Admin/Hostel/action');?>" method="post">
                ...
                <table width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <td width="10%" align="center">点赞数</td>
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="left">
                                    ...
                                    <span title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["sortitle"]); ?></span>
                                </td>
                                <!-- <td align="center"><?php echo ((isset($vo["votenum"]) && ($vo["votenum"] !== ""))?($vo["votenum"]):"0"); ?></td> -->
                                <td align="center"><?php echo ((isset($vo["hit"]) && ($vo["hit"] !== ""))?($vo["hit"]):"0"); ?></td>
                                <td align="center"><?php echo (date("Y-m-d H:i:s",$vo["inputtime"])); ?></td>
                                <td align="center"><?php echo ($vo["username"]); ?></td>
                                <td align="center">
                                    <?php if(($vo['status']) == "1"): if(authcheck('Admin/Hostel/review')): ?><a href="javascript:;" onClick="omnipotent('selectid','<?php echo U('Admin/Hostel/review',array('id'=>$vo['id']));?>','审核',1,700,300)">审核</a>
                                          <?php else: ?>
                                          <font color="#cccccc">审核</font><?php endif; endif; ?>
                                    <?php if(authcheck('Admin/Room/index')): ?><a href="<?php echo U('Admin/Room/index',array('hid'=>$vo['id']));?>">管理房间</a>
                                        <?php else: ?>
                                        <font color="#cccccc">管理房间</font><?php endif; ?>
                                    <?php if(($vo['isoff']) == "0"): if(authcheck('Admin/Hostel/setoff')): ?><a href="<?php echo U('Admin/Hostel/setoff',array('id'=>$vo['id'],'isoff'=>1));?>" >下架 </a>
                                            <?php else: ?>
                                            <font color="#cccccc">下架</font><?php endif; ?>  
                                    <?php else: ?>
                                        <?php if(authcheck('Admin/Hostel/setoff')): ?><a href="<?php echo U('Admin/Hostel/setoff',array('id'=>$vo['id'],'isoff'=>0));?>" >启用 </a>
                                            <?php else: ?>
                                            <font color="#cccccc">启用</font><?php endif; endif; ?>
                                    <?php if(authcheck('Admin/Hostel/edit')): ?><a href="<?php echo U('Admin/Hostel/edit',array('id'=>$vo['id']));?>">修改</a>
                                        <?php else: ?>
                                        <font color="#cccccc">修改</font><?php endif; ?>
                                    <?php if(authcheck('Admin/Hostel/delete')): ?><a href="<?php echo U('Admin/Hostel/delete',array('id'=>$vo['id']));?>" class="del">删除</a>
                                        <?php else: ?>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    ...
                    <?php if(authcheck('Admin/Hostel/listorder')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="listorder">排序</button><?php endif; ?>
                    <?php if(authcheck('Admin/Hostel/jinpins')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="jinpins">精品</button><?php endif; ?>
                      <?php if(authcheck('Admin/Hostel/unjinpins')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unjinpins">取消精品</button><?php endif; ?>
                    <?php if(authcheck('Admin/Hostel/pushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="pushs">推荐</button><?php endif; ?>
                    <?php if(authcheck('Admin/Hostel/unpushs')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="unpushs">取消推荐</button><?php endif; ?>
                    <?php if(authcheck('Admin/Hostel/del')): ?><button class="btn btn_submit mr10 " type="submit" name="submit" value="del">删除</button><?php endif; ?>
